...
class MediaSessionCompatApi24 {
    ...
    public static String getCallingPackage(Object obj) {
        MediaSession mediaSessionM21922a = C4722lB.m21922a(obj);
        try {
            return (String) mediaSessionM21922a.getClass().getMethod("getCallingPackage", null).invoke(mediaSessionM21922a, null);
