...
public final class MediaControllerCompat {
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(C0060Av.m278a("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        ...
        try {
            int i = Build.VERSION.SDK_INT;
            mediaControllerImplApi24 = i >= 24 ? new MediaControllerImplApi24(context, sessionToken) : i >= 23 ? new MediaControllerImplApi23(context, sessionToken) : i >= 21 ? new MediaControllerImplApi21(context, sessionToken) : new MediaControllerImplBase(sessionToken);
        } catch (RemoteException e) {
