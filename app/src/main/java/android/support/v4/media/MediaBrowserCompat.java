...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            ...
            StringBuilder sbM27771a = C5274qy.m27771a("Unknown result code: ", i, " (extras=");
            sbM27771a.append(this.mExtras);
            sbM27771a.append(", resultData=");
            sbM27771a.append(bundle);
            sbM27771a.append(C1313UP.f3459l);
            Log.w(MediaBrowserCompat.TAG, sbM27771a.toString());
        }
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void connect() {
            C5890zy.m30205a(this.mBrowserFwk);
        }
        ...
        public void disconnect() {
            ...
            C5624vy.m29201a(this.mBrowserFwk);
        }

        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        @Nullable
        public Bundle getExtras() {
            return C5553uy.m28737a(this.mBrowserFwk);
        }
        ...
        public void getItem(@NonNull final String str, @NonNull final ItemCallback itemCallback) {
            ...
            if (!C5408sy.m28316a(this.mBrowserFwk)) {
        ...
        public String getRoot() {
            return C5755xy.m29714a(this.mBrowserFwk);
        }

        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public ComponentName getServiceComponent() {
            return C5820yy.m29915a(this.mBrowserFwk);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            if (this.mMediaSessionToken == null) {
                this.mMediaSessionToken = MediaSessionCompat.Token.fromToken(C5490ty.m28557a(this.mBrowserFwk));
            }
        ...
        public boolean isConnected() {
            return C5408sy.m28316a(this.mBrowserFwk);
        }

        @Override // android.support.v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
        public void onConnected() {
            try {
                Bundle bundleM28737a = C5553uy.m28737a(this.mBrowserFwk);
                if (bundleM28737a == null) {
                    return;
                }
                this.mServiceVersion = bundleM28737a.getInt(MediaBrowserProtocol.EXTRA_SERVICE_VERSION, 0);
                IBinder binder = BundleCompat.getBinder(bundleM28737a, MediaBrowserProtocol.EXTRA_MESSENGER_BINDER);
                if (binder != null) {
                ...
                IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(BundleCompat.getBinder(bundleM28737a, MediaBrowserProtocol.EXTRA_SESSION_BINDER));
                if (iMediaSessionAsInterface != null) {
                    this.mMediaSessionToken = MediaSessionCompat.Token.fromToken(C5490ty.m28557a(this.mBrowserFwk), iMediaSessionAsInterface);
                }
        ...
        public void subscribe(@NonNull String str, Bundle bundle, @NonNull SubscriptionCallback subscriptionCallback) {
            ...
            if (serviceBinderWrapper == null) {
                C5337ry.m28063a(this.mBrowserFwk, str, subscriptionCallback.mSubscriptionCallbackFwk);
                return;
            }
            try {
        ...
        public void unsubscribe(@NonNull String str, SubscriptionCallback subscriptionCallback) {
            ...
            if (serviceBinderWrapper != null) {
                ...
                C5688wy.m29354a(this.mBrowserFwk, str);
            } else {
    ...
    public static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (this.mServiceBinderWrapper == null) {
                C0063Ay.m406a(this.mBrowserFwk, str, itemCallback.mItemCallbackFwk);
            } else {
    ...
    public static class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
        ...
        public void subscribe(@NonNull String str, @Nullable Bundle bundle, @NonNull SubscriptionCallback subscriptionCallback) {
            if (this.mServiceBinderWrapper != null && this.mServiceVersion >= 2) {
                ...
                C0127By.m819a(this.mBrowserFwk, str, bundle, subscriptionCallback.mSubscriptionCallbackFwk);
            }
        }
        ...
        public void unsubscribe(@NonNull String str, SubscriptionCallback subscriptionCallback) {
            if (this.mServiceBinderWrapper != null && this.mServiceVersion >= 2) {
                ...
                C0199Cy.m1191a(this.mBrowserFwk, str, subscriptionCallback.mSubscriptionCallbackFwk);
            }
        }
    }
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbM3902a = C0835Mx.m3902a(str, " for ");
                sbM3902a.append(MediaBrowserImplBase.this.mServiceComponent);
                sbM3902a.append(" with mServiceConnection=");
                sbM3902a.append(MediaBrowserImplBase.this.mServiceConnection);
                sbM3902a.append(" this=");
                sbM3902a.append(this);
                Log.i(MediaBrowserCompat.TAG, sbM3902a.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i) {
            ...
            if (i != 3) {
                return i != 4 ? C5630w2.m29215a("UNKNOWN/", i) : "CONNECT_STATE_SUSPENDED";
            }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbM3902a = C0835Mx.m3902a(str, " for ");
            sbM3902a.append(this.mServiceComponent);
            sbM3902a.append(" with mCallbacksMessenger=");
            sbM3902a.append(this.mCallbacksMessenger);
            sbM3902a.append(" this=");
            sbM3902a.append(this);
            Log.i(MediaBrowserCompat.TAG, sbM3902a.toString());
            return false;
        ...
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
                throw new IllegalStateException(C0786MA.m3668a(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), C1313UP.f3459l));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(C0786MA.m3668a(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), C1313UP.f3459l));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(C0786MA.m3668a(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), C1313UP.f3459l));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(C0978P9.m4377a(new StringBuilder("getServiceComponent() called while not connected (state="), this.mState, C1313UP.f3459l));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(C0978P9.m4377a(new StringBuilder("getSessionToken() called while not connected(state="), this.mState, C1313UP.f3459l));
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(C0786MA.m3668a(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), C1313UP.f3459l));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e) {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public static MediaItem fromMediaItem(Object obj) {
            ...
            MediaBrowser.MediaItem mediaItemM1496a = C0263Dy.m1496a(obj);
            return new MediaItem(MediaDescriptionCompat.fromMediaDescription(C0390Fy.m1970a(mediaItemM1496a)), C0327Ey.m1720a(mediaItemM1496a));
        }
        ...
        public String toString() {
            return "MediaItem{mFlags=" + this.mFlags + ", mDescription=" + this.mDescription + MessageFormatter.f17214b;
        }
