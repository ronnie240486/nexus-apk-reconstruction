...
public class RoundedImageViewFixWHR extends ImageView {
    ...
    /* JADX INFO: renamed from: com.makeramen.roundedimageview.RoundedImageViewFixWHR$1 */
    public static /* synthetic */ class C38771 {
    ...
    public RoundedImageViewFixWHR(Context context) {
    }

    /* JADX WARN: Invalid debug info offset */
    public RoundedImageViewFixWHR(Context context, AttributeSet attributeSet) {
    }

    /* JADX WARN: Invalid debug info offset */
    public RoundedImageViewFixWHR(Context context, AttributeSet attributeSet, int i) {
    }
    ...
    private android.graphics.drawable.Drawable resolveBackgroundResource() {
        ...
        L11:
        */
        throw new UnsupportedOperationException("Method not decompiled: com.makeramen.roundedimageview.RoundedImageViewFixWHR.resolveBackgroundResource():android.graphics.drawable.Drawable");
    }
    ...
    private android.graphics.drawable.Drawable resolveResource() {
        ...
        L11:
        */
        throw new UnsupportedOperationException("Method not decompiled: com.makeramen.roundedimageview.RoundedImageViewFixWHR.resolveResource():android.graphics.drawable.Drawable");
    }
