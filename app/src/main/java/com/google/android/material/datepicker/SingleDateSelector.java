...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C3387R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C3387R.string.mtrl_picker_date_header_title;
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C3387R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C3387R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l.longValue()));
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View viewInflate = layoutInflater.inflate(C3387R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C3387R.id.mtrl_picker_text_input_date);
