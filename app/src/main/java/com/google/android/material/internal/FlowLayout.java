...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C3387R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(C3387R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(C3387R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public int getRowIndex(@NonNull View view) {
        Object tag = view.getTag(C3387R.id.row_index_key);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(C3387R.id.row_index_key, -1);
            } else {
                ...
                childAt.setTag(C3387R.id.row_index_key, Integer.valueOf(this.rowCount - 1));
