...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(@NonNull Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C3387R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis) ? C3387R.attr.materialCalendarTheme : C3387R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C3387R.string.mtrl_picker_range_header_title;
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C3387R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C3387R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(l.longValue()));
        }
        if (l == null) {
            return resources.getString(C3387R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(l2.longValue()));
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
        return resources.getString(C3387R.string.mtrl_picker_range_header_selected, dateRangeString.first, dateRangeString.second);
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        View viewInflate = layoutInflater.inflate(C3387R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C3387R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = (TextInputLayout) viewInflate.findViewById(C3387R.id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = viewInflate.getResources().getString(C3387R.string.mtrl_picker_invalid_range);
