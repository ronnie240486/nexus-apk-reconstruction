...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C3387R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C3387R.style.Widget_MaterialComponents_CardView;
    ...
    public void setShapeAppearanceModel(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        if (Build.VERSION.SDK_INT >= 21) {
            C1347Ux.m6430a(this, shapeAppearanceModel.isRoundRect(getBoundsAsRectF()));
        }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3387R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C3387R.styleable.MaterialCardView, i, i2, new int[0]);
