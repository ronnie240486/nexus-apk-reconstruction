...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.getDrawable(context, C3387R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C3387R.drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelSize(C3387R.dimen.mtrl_calendar_navigation_height);
        int dimensionPixelSize = resources.getDimensionPixelSize(C3387R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return C0050Al.m223a(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_month_vertical_padding) * (i - 1)) + (resources.getDimensionPixelSize(C3387R.dimen.mtrl_calendar_day_height) * i), resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_bottom_padding));
    }

    private static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return ((i - 1) * resources.getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_month_horizontal_padding)) + (resources.getDimensionPixelSize(C3387R.dimen.mtrl_calendar_day_width) * i) + (dimensionPixelOffset * 2);
    }
    ...
    public static boolean isNestedScrollable(@NonNull Context context) {
        return readMaterialCalendarStyleBoolean(context, C3387R.attr.nestedScrollable);
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C3387R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    public void startPickerFragment() {
        ...
        fragmentTransactionBeginTransaction.replace(C3387R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C3387R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(checkableImageButton.getContext().getString(this.headerToggleButton.isChecked() ? C3387R.string.mtrl_picker_toggle_to_calendar_input_mode : C3387R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(context, C3387R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C3387R.attr.materialCalendarStyle, C3387R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C3387R.layout.mtrl_picker_fullscreen : C3387R.layout.mtrl_picker_dialog, viewGroup);
        Context context = viewInflate.getContext();
        if (this.fullscreen) {
            viewInflate.findViewById(C3387R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View viewFindViewById = viewInflate.findViewById(C3387R.id.mtrl_calendar_main_pane);
            View viewFindViewById2 = viewInflate.findViewById(C3387R.id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) viewInflate.findViewById(C3387R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C3387R.id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) viewInflate.findViewById(C3387R.id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) viewInflate.findViewById(C3387R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C3387R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C3387R.dimen.mtrl_calendar_dialog_background_inset);
