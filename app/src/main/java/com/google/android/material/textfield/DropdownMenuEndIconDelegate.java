...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void addRippleEffect(@NonNull AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C3387R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C3387R.attr.colorSurface);
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
    ...
    public void initialize() {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C3387R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C3387R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C3387R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C3387R.drawable.mtrl_dropdown_arrow : C3387R.drawable.mtrl_ic_arrow_drop_down));
        TextInputLayout textInputLayout = this.textInputLayout;
        textInputLayout.setEndIconContentDescription(textInputLayout.getResources().getText(C3387R.string.exposed_dropdown_menu_content_description));
