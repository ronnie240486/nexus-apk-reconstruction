...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setHour(@IntRange(from = 0, m14516to = 23) int i) {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = 0, m14516to = 60) int i) {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C3387R.string.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C3387R.string.material_timepicker_clock_mode_description));
        }
        throw new IllegalArgumentException(C5630w2.m29215a("no icon for mode: ", i));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        TypedValue typedValueResolve = MaterialAttributes.resolve(requireContext(), C3387R.attr.materialTimePickerTheme);
        Dialog dialog = new Dialog(requireContext(), typedValueResolve == null ? 0 : typedValueResolve.data);
        Context context = dialog.getContext();
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(context, C3387R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C3387R.attr.materialTimePickerStyle, C3387R.style.Widget_MaterialComponents_TimePicker);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C3387R.styleable.MaterialTimePicker, C3387R.attr.materialTimePickerStyle, C3387R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = typedArrayObtainStyledAttributes.getResourceId(C3387R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = typedArrayObtainStyledAttributes.getResourceId(C3387R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C3387R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C3387R.id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C3387R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C3387R.id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C3387R.id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C3387R.id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.2
        ...
        ((Button) viewGroup2.findViewById(C3387R.id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
