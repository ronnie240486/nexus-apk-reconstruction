...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C3387R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C3387R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C3387R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C3387R.dimen.mtrl_switch_thumb_elevation);
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3387R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C3387R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C3387R.styleable.SwitchMaterial_useMaterialThemeColors, false);
