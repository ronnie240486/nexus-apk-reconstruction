...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    private void updateHintLocales() {
        if (Build.VERSION.SDK_INT >= 24) {
            C0466H9.m2268a(this.editText, C4905nw.m22540a(getContext().getResources().getConfiguration()));
        }
    }
    ...
    public ChipTextInputComboView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) layoutInflaterFrom.inflate(C3387R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        TextInputLayout textInputLayout = (TextInputLayout) layoutInflaterFrom.inflate(C3387R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C3387R.id.material_label);
