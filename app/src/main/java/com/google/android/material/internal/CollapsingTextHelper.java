...
public final class CollapsingTextHelper {
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x00dc A[DONT_INVERT] */
    ...
    private void calculateBaseOffsets() {
        ...
        if (charSequence2 != null && (staticLayout3 = this.textLayout) != null) {
            this.textToDrawCollapsed = TextUtils.ellipsize(charSequence2, this.textPaint, staticLayout3.getWidth(), TextUtils.TruncateAt.END);
        }
        ...
        int i3 = absoluteGravity & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW;
        if (i3 != 48) {
            this.collapsedDrawY = i3 != 80 ? this.collapsedBounds.centerY() - ((this.textPaint.descent() - this.textPaint.ascent()) / 2.0f) : this.textPaint.ascent() + this.collapsedBounds.bottom;
        } else {
        ...
        if (i4 != 1) {
            if (i4 != 5) {
                ...
                fCenterX = this.collapsedBounds.right;
            }
            ...
            if (charSequence != null) {
                width = this.textPaint.measureText(charSequence, 0, charSequence.length());
            } else {
                width = 0.0f;
            }
            ...
            i = absoluteGravity2 & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW;
            if (i != 48) {
                if (i != 80) {
                    this.expandedDrawY = this.expandedBounds.centerY() - (height / 2.0f);
                } else {
                    fDescent = this.textPaint.descent() + (this.expandedBounds.bottom - height);
                }
                i2 = absoluteGravity2 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
                if (i2 != 1) {
                    if (i2 != 5) {
                        f = this.expandedBounds.left;
                    } else {
                        fCenterX2 = this.expandedBounds.right;
                    }
                    this.expandedDrawX = f;
                    clearTexture();
                    setInterpolatedTextSize(f2);
                }
                fCenterX2 = this.expandedBounds.centerX();
                width /= 2.0f;
                f = fCenterX2 - width;
                this.expandedDrawX = f;
                clearTexture();
            ...
            fDescent = this.expandedBounds.top;
            this.expandedDrawY = fDescent;
            i2 = absoluteGravity2 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
            if (i2 != 1) {
                if (i2 != 5) {
                    f = this.expandedBounds.left;
        ...
        fCenterX = this.collapsedBounds.centerX();
        fMeasureText /= 2.0f;
        this.collapsedDrawX = fCenterX - fMeasureText;
        calculateUsingTextSize(this.expandedTextSize);
        staticLayout = this.textLayout;
        if (staticLayout != null) {
            height = staticLayout.getHeight();
        ...
        this.expandedFirstLineDrawX = staticLayout5 != null ? staticLayout5.getLineLeft(0) : 0.0f;
        int absoluteGravity3 = GravityCompat.getAbsoluteGravity(this.expandedTextGravity, this.isRtl ? 1 : 0);
        i = absoluteGravity3 & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW;
        if (i != 48) {
            if (i != 80) {
                this.expandedDrawY = this.expandedBounds.centerY() - (height / 2.0f);
            } else {
            ...
            i2 = absoluteGravity3 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
            if (i2 != 1) {
                if (i2 != 5) {
                    f = this.expandedBounds.left;
                } else {
    ...
    private void calculateOffsets(float f) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (f2 != f3) {
                C1716aa.m9128a(this.textPaint, lerp(f3, f2, f, timeInterpolator));
            } else {
                C1716aa.m9128a(this.textPaint, f2);
            }
        }
    ...
    private void getTextPaintCollapsed(@NonNull TextPaint textPaint) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            C1716aa.m9128a(textPaint, this.collapsedLetterSpacing);
        }
    }
    ...
    private void getTextPaintExpanded(@NonNull TextPaint textPaint) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            C1716aa.m9128a(textPaint, this.expandedLetterSpacing);
        }
    }
