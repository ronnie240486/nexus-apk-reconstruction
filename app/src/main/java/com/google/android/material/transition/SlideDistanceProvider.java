...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i, @Px int i2) {
        ...
        throw new IllegalArgumentException(C5630w2.m29215a("Invalid slide direction: ", i));
    }
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return i != -1 ? i : context.getResources().getDimensionPixelSize(C3387R.dimen.mtrl_transition_shared_axis_slide_distance);
    }
