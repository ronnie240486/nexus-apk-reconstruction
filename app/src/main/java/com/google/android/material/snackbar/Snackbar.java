...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C3387R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C3387R.attr.snackbarTextViewStyle};
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C3387R.layout.mtrl_layout_snackbar_include : C3387R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
    ...
    public int getDuration() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            return C5723xS.m29630a(this.accessibilityManager, duration, (this.hasAction ? 4 : 0) | 3);
        }
