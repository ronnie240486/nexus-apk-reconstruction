...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C3387R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    ...
                    i = C3387R.string.mtrl_picker_toggle_to_year_selection;
                } else {
                    materialCalendar = MaterialCalendar.this;
                    i = C3387R.string.mtrl_picker_toggle_to_day_selection;
                }
                accessibilityNodeInfoCompat.setHintText(materialCalendar.getString(i));
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C3387R.id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C3387R.id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C3387R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C3387R.id.mtrl_calendar_day_selector_frame);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i, int i2) {
                ...
                int iFindFirstVisibleItemPosition = i < 0 ? layoutManager.findFirstVisibleItemPosition() : layoutManager.findLastVisibleItemPosition();
    ...
    public static int getDayHeight(@NonNull Context context) {
        return context.getResources().getDimensionPixelSize(C3387R.dimen.mtrl_calendar_day_height);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i = C3387R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C3387R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(i, viewGroup, false);
        GridView gridView = (GridView) viewInflate.findViewById(C3387R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C3387R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C3387R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C3387R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C3387R.id.month_navigation_fragment_toggle) != null) {
