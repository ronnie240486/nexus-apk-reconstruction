...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C3387R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C3387R.attr.colorSurface, C3387R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C3387R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C3387R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C3387R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C3387R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C3387R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C3387R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C3387R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C3387R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C3387R.attr.snackbarStyle};
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C3387R.layout.mtrl_layout_snackbar : C3387R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        throw new IllegalArgumentException(C5630w2.m29215a("Unable to find anchor view with id: ", i));
    }
    ...
    public final void showView() {
        this.view.setOnAttachStateChangeListener(new OnAttachStateChangeListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.7
            ...
            public void onViewAttachedToWindow(View view) {
                WindowInsets windowInsetsM27794a;
                if (Build.VERSION.SDK_INT < 29 || (windowInsetsM27794a = C5283r6.m27794a(BaseTransientBottomBar.this.view)) == null) {
                    return;
                }
                BaseTransientBottomBar.this.extraBottomMarginGestureInset = C0045Ag.m210a(C5989j50.m21498a(windowInsetsM27794a));
                BaseTransientBottomBar.this.updateMargins();
            }
