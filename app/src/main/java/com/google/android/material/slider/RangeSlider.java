...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C3387R.styleable.RangeSlider, i, BaseSlider.DEF_STYLE_RES, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C3387R.styleable.RangeSlider_values)) {
            setValues(convertToFloat(typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(C3387R.styleable.RangeSlider_values, 0))));
        }
        this.minSeparation = typedArrayObtainStyledAttributes.getDimension(C3387R.styleable.RangeSlider_minSeparation, 0.0f);
