...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f11169IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.platform.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f11169IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f11169IN;
        }
        if (i == 2) {
            return CROSS;
        }
