...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, m14515to = 1.0d) float f, @FloatRange(from = 0.0d, m14515to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, @ColorInt int i, @ColorInt int i2, @ColorInt int i3, int i4, boolean z, boolean z2, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z3) {
            ...
            PathMeasure pathMeasure = new PathMeasure(C1605Yx.m8258a(pathMotion, motionPathPoint.x, motionPathPoint.y, motionPathPoint2.x, motionPathPoint2.y), false);
        ...
        private void updateProgress(float f) {
            ...
            float fM1419a = fArr[0];
            float fM1419a2 = fArr[1];
            if (f > 1.0f || f < 0.0f) {
                if (f > 1.0f) {
                ...
                float f4 = fArr2[0];
                float f5 = fArr2[1];
                fM1419a = C0245Dg.m1419a(fM1419a, f4, f3, fM1419a);
                fM1419a2 = C0245Dg.m1419a(fM1419a2, f5, f3, fM1419a2);
            }
            float f6 = fM1419a;
            float f7 = fM1419a2;
            ...
            rectF2.set(f6 - (f9 / 2.0f), f7, (f9 / 2.0f) + f6, fitModeResult.currentEndHeight + f7);
    ...
    private ProgressThresholdsGroup buildThresholdsGroup(boolean z) {
        ...
        PathMotion pathMotionM6945a = C1479Wx.m6945a(this);
        if (C1542Xx.m8029a(pathMotionM6945a) || (pathMotionM6945a instanceof MaterialArcMotion)) {
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (i == -1) {
            if (view == null) {
                if (transitionValues.view.getTag(C3387R.id.mtrl_motion_snapshot_view) instanceof View) {
                    view = (View) transitionValues.view.getTag(C3387R.id.mtrl_motion_snapshot_view);
                    transitionValues.view.setTag(C3387R.id.mtrl_motion_snapshot_view, null);
                }
            }
        ...
        view = TransitionUtils.findDescendantOrAncestorById(transitionValues.view, i);
    ...
    private static ShapeAppearanceModel getShapeAppearance(@NonNull View view, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C3387R.id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C3387R.id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(new int[]{C3387R.attr.transitionShapeAppearance});
