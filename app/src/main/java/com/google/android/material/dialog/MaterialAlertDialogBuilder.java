...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    @AttrRes
    private static final int DEF_STYLE_ATTR = C3387R.attr.alertDialogStyle;

    @StyleRes
    private static final int DEF_STYLE_RES = C3387R.style.MaterialAlertDialog_MaterialComponents;

    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C3387R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C3387R.attr.colorSurface, getClass().getCanonicalName());
