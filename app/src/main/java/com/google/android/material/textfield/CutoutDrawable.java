...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    private void saveCanvasLayer(@NonNull Canvas canvas) {
        this.savedLayer = Build.VERSION.SDK_INT >= 21 ? C4233dd.m19937a(canvas, 0.0f, 0.0f, canvas.getWidth(), canvas.getHeight(), null) : canvas.saveLayer(0.0f, 0.0f, canvas.getWidth(), canvas.getHeight(), null, 31);
    }
