...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m17610id = 2)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m17610id = 3)
    private final PendingIntent zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m17610id = 4)
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return C5954f00.m20225a("UNKNOWN_ERROR_CODE(", i, C1313UP.f3459l);
                }
        }
    }
    ...
    public ConnectionResult(@SafeParcelable.Param(m17611id = 1) int i, @SafeParcelable.Param(m17611id = 2) int i2, @Nullable @SafeParcelable.Param(m17611id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m17611id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
