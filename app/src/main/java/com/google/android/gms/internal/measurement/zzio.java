...
public abstract class zzio<MessageType extends zzio<MessageType, BuilderType>, BuilderType extends zzin<MessageType, BuilderType>> implements zzlm {
    ...
    public final zzje zzbs() {
        try {
            ...
            throw new RuntimeException(C0060Av.m278a("Serializing ", getClass().getName(), " to a ByteString threw an IOException (should never happen)."), e);
        }
    }
    ...
    public final byte[] zzbu() {
        try {
            ...
            throw new RuntimeException(C0060Av.m278a("Serializing ", getClass().getName(), " to a byte array threw an IOException (should never happen)."), e);
        }
    }
}
