...
public final class zzdu {
    ...
    public static final zzdt zzd = zza("measurement.config.url_scheme", NetworkRequestHandler.f12459e, NetworkRequestHandler.f12459e, new zzdq() { // from class: com.google.android.gms.measurement.internal.zzbz
        @Override // com.google.android.gms.measurement.internal.zzdq
        public final Object zza() {
            zzdt zzdtVar = zzdu.zza;
            return zznn.zzK();
    ...
    static {
        Long lValueOf = Long.valueOf(DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
