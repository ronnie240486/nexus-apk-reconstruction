...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.VersionField(m17613id = 1000)
    final int zzb;

    @SafeParcelable.Field(getter = "getStatusCode", m17610id = 1)
    private final int zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", m17610id = 2)
    private final String zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m17610id = 3)
    private final PendingIntent zze;

    @Nullable
    @SafeParcelable.Field(getter = "getConnectionResult", m17610id = 4)
    ...
    public Status(@SafeParcelable.Param(m17611id = 1000) int i, @SafeParcelable.Param(m17611id = 1) int i2, @Nullable @SafeParcelable.Param(m17611id = 2) String str, @Nullable @SafeParcelable.Param(m17611id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m17611id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
