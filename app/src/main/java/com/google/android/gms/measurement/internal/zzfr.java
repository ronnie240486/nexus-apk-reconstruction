...
public final class zzfr implements zzgm {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (zzhxVarZzq.zzt.zze.getApplicationContext() instanceof Application) {
                ...
                if (z) {
                    ...
                    e70.m20045a(zzhxVarZzq.zzt, "Registered activity lifecycle callback");
                }
            }
        } else {
            C4391g4.m20722a(this, "Application context is not an Application");
        }
    ...
    public final void zzE() {
        ...
        if (activeNetworkInfo == null || !activeNetworkInfo.isConnected()) {
            C4391g4.m20722a(this, "Network is not available for Deferred Deep Link request. Skipping");
            return;
        }
        zzlb zzlbVarZzv = zzv();
        zzh().zzt.zzk.zzh();
    ...
    public final void zzH(com.google.android.gms.internal.measurement.zzcl zzclVar) {
        ...
        if (zzM()) {
            ...
            if (!zzv().zzad("android.permission.INTERNET")) {
                C4327f4.m20229a(this, "App is missing INTERNET permission");
            }
            if (!zzv().zzad("android.permission.ACCESS_NETWORK_STATE")) {
                C4327f4.m20229a(this, "App is missing ACCESS_NETWORK_STATE permission");
            }
            if (!Wrappers.packageManager(this.zze).isCallerInstantApp() && !this.zzk.zzx()) {
                if (!zzlb.zzaj(this.zze)) {
                    C4327f4.m20229a(this, "AppMeasurementReceiver not registered/enabled");
                }
                if (!zzlb.zzak(this.zze, false)) {
                    C4327f4.m20229a(this, "AppMeasurementService not registered/enabled");
                }
            }
            C4327f4.m20229a(this, "Uploading is not possible. App measurement disabled");
        }
        zzm().zzi.zza(true);
    }
