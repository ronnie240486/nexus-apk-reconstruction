...
public abstract class zzkf<MessageType extends zzkf<MessageType, BuilderType>, BuilderType extends zzkb<MessageType, BuilderType>> extends zzio<MessageType, BuilderType> {
    ...
    public final int zzbr(zzlx zzlxVar) {
        if (zzbO()) {
            ...
            throw new IllegalStateException(C5630w2.m29215a("serialized size must be non-negative, was ", iZza));
        }
        ...
        if (iZza2 < 0) {
            throw new IllegalStateException(C5630w2.m29215a("serialized size must be non-negative, was ", iZza2));
        }
