...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(C5630w2.m29215a("Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(C2998bp.m14684a("Size read is invalid start=", iDataPosition, " end=", i), parcel);
        }
        return i;
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(C0786MA.m3668a(C1469Wn.m6925a("Expected size ", i3, " got ", i2, " (0x"), Integer.toHexString(i2), C1313UP.f3459l), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(C0786MA.m3668a(C1469Wn.m6925a("Expected size ", i2, " got ", size, " (0x"), Integer.toHexString(size), C1313UP.f3459l), parcel);
    }
}
