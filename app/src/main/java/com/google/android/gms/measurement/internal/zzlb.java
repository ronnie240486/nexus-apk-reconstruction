...
public final class zzlb extends zzgl {
    ...
    public final Object zzB(String str, Object obj) {
        ...
        int iZzaq = zzaq(str);
        return zEquals ? zzar(iZzaq, obj, true, false) : zzar(iZzaq, obj, false, false);
    }
    ...
    public final void zzM(zzei zzeiVar, int i) {
        ...
        for (String str : new TreeSet(zzeiVar.zzd.keySet())) {
            if (zzai(str) && (i2 = i2 + 1) > i) {
                this.zzt.zzay().zze().zzc(C5274qy.m27771a("Event can't contain more than ", i, " params").toString(), this.zzt.zzj().zzd(zzeiVar.zza), this.zzt.zzj().zzb(zzeiVar.zzd));
                zzao(zzeiVar.zzd, 5);
    ...
    public final void zzP(com.google.android.gms.internal.measurement.zzcf zzcfVar, boolean z) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(Tailer.f15848j, z);
        try {
            zzcfVar.zze(bundle);
    ...
    public final void zzQ(com.google.android.gms.internal.measurement.zzcf zzcfVar, ArrayList arrayList) {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(Tailer.f15848j, arrayList);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzS(com.google.android.gms.internal.measurement.zzcf zzcfVar, byte[] bArr) {
        Bundle bundle = new Bundle();
        bundle.putByteArray(Tailer.f15848j, bArr);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzT(com.google.android.gms.internal.measurement.zzcf zzcfVar, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt(Tailer.f15848j, i);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzU(com.google.android.gms.internal.measurement.zzcf zzcfVar, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong(Tailer.f15848j, j);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzV(com.google.android.gms.internal.measurement.zzcf zzcfVar, String str) {
        Bundle bundle = new Bundle();
        bundle.putString(Tailer.f15848j, str);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzW(String str, String str2, String str3, Bundle bundle, List list, boolean z) {
        ...
        for (String str4 : new TreeSet(bundle.keySet())) {
            ...
            if (i != 0) {
                zzJ(bundle, i, str4, str4, i == 3 ? str4 : null);
                bundle.remove(str4);
            } else {
                if (zzaf(bundle.get(str4))) {
                    this.zzt.zzay().zzl().zzd("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str2, str3, str4);
                    iZza = 22;
                } else {
        ...
        if (obj instanceof Bundle) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                if (!(obj3 instanceof Bundle)) {
                    zzefVarZzl = this.zzt.zzay().zzl();
                    obj2 = obj3 != null ? obj3.getClass() : AndroidLoggerFactory.f17234b;
                    str4 = "All ArrayList elements must be of type Bundle. Value type, name";
                    zzefVarZzl.zzc(str4, obj2, str3);
                    return 4;
                }
                zzW(str, str2, str3, (Bundle) obj3, list, z);
            }
        }
        return i;
    }
    ...
    public final void zzaA() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                C4391g4.m20722a(this.zzt, "Utils falling back to Random for random id");
            }
        }
    ...
    public final int zzd(String str, Object obj) {
        return zzaa("_ldl".equals(str) ? "user property referrer" : "user property", str, zzaq(str), obj) ? 0 : 7;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:51:0x00fc A[SYNTHETIC] */
            ...
            if (i != 0) {
                ...
                if (iZza == 17) {
                    ...
                    if (!zzai(str3)) {
                        i3 = i4 + 1;
                        if (i3 > i2) {
                            this.zzt.zzay().zze().zzc(C5274qy.m27771a("Event can't contain more than ", i2, " params").toString(), this.zzt.zzj().zzd(str2), this.zzt.zzj().zzb(bundle));
                            zzao(bundle2, 5);
                            bundle2.remove(str3);
                        }
                        i4 = i3;
