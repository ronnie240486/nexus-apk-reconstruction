...
public final class zznp implements zzno {
    ...
    static {
        ...
        zzf = zzhyVarZza.zze("measurement.config.url_scheme", NetworkRequestHandler.f12459e);
        ...
        zzr = zzhyVarZza.zzd("measurement.service_client.idle_disconnect_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
