...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 3) {
            zzap zzapVarZzb = zzgVar.zzb((zzap) c70.m16439a(zzbl.ASSIGN, 2, list, 0));
        ...
        if (iOrdinal == 33) {
            zzap zzapVarZzb5 = zzgVar.zzb((zzap) c70.m16439a(zzbl.GET, 1, list, 0));
        ...
        if (iOrdinal == 58) {
            zzap zzapVarZzb6 = zzgVar.zzb((zzap) c70.m16439a(zzbl.SET_PROPERTY, 3, list, 0));
        ...
        if (iOrdinal == 35 || iOrdinal == 36) {
            zzap zzapVarZzb12 = zzgVar.zzb((zzap) c70.m16439a(zzbl.GET_PROPERTY, 2, list, 0));
            ...
            if (zzapVarZzb12 instanceof zzat) {
                if (C5316rd.f18633d.equals(zzapVarZzb13.zzi())) {
        ...
        switch (iOrdinal) {
            case VLCUtil.f17716h /* 62 */:
                zzap zzapVarZzb14 = zzgVar.zzb((zzap) c70.m16439a(zzbl.TYPEOF, 1, list, 0));
