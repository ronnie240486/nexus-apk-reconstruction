...
final class zzcx extends zzdu {
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzcc) Preconditions.checkNotNull(this.zze.zzj)).initialize(ObjectWrapper.wrap(this.zzc), new zzcl(74029L, Math.max(localVersion, remoteVersion), remoteVersion < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzfj.zza(this.zzc)), this.zzh);
        } catch (Exception e) {
