...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal build() {
            String strM21289a = this.transportName == null ? " transportName" : "";
            if (this.encodedPayload == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " encodedPayload");
            }
            if (this.eventMillis == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " eventMillis");
            }
            if (this.uptimeMillis == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " uptimeMillis");
            }
            if (this.autoMetadata == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " autoMetadata");
            }
