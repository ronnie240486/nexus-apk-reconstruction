...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    private static final String CREATE_INITIAL_GLOBAL_LOG_EVENT_STATE_VALUE_SQL = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + C1313UP.f3459l;
    ...
    static {
        Migration migration = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.C
        ...
        Migration migration2 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.D
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
        ...
        Migration migration3 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.E
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
        ...
        Migration migration4 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.F
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
        ...
        Migration migration5 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.G
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
    ...
    @InterfaceC4441gs
    public SchemaManager(Context context, @InterfaceC5773yD("SQLITE_DB_NAME") String str, @InterfaceC5773yD("SCHEMA_VERSION") int i) {
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i2 <= list.size()) {
            ...
            StringBuilder sbM6925a = C1469Wn.m6925a("Migration from ", i, " to ", i2, " was requested, but cannot be performed. Only ");
            sbM6925a.append(list.size());
            sbM6925a.append(" migrations are provided");
            throw new IllegalArgumentException(sbM6925a.toString());
        }
    }
