...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int iIntValue = Integer.valueOf(intent.getData().getQueryParameter(C4615jV.f14798l)).intValue();
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i, new Runnable() { // from class: v2
