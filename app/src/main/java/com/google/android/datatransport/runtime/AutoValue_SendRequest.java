...
final class AutoValue_SendRequest extends SendRequest {
    ...
    public static final class Builder extends SendRequest.Builder {
        ...
        public SendRequest build() {
            String strM21289a = this.transportContext == null ? " transportContext" : "";
            if (this.transportName == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " transportName");
            }
            if (this.event == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " event");
            }
            if (this.transformer == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " transformer");
            }
            if (this.encoding == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " encoding");
            }
