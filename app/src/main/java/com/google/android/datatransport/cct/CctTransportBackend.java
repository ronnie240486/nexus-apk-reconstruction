...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m17431i(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        httpURLConnection.setRequestProperty(C1025Pu.a.f2646e, String.format("datatransport/%s android/", "3.1.8"));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m17431i(LOG_TAG, "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m17427d(LOG_TAG, "Content-Type: %s", httpURLConnection.getHeaderField(CONTENT_TYPE_HEADER_KEY));
                    Logging.m17427d(LOG_TAG, "Content-Encoding: %s", httpURLConnection.getHeaderField(CONTENT_ENCODING_HEADER_KEY));
            ...
            e = e;
            Logging.m17430e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(TbsListener.ErrorCode.INFO_CODE_BASE, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m17430e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m17430e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m17421of("proto"))) {
                    builderProtoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m17421of("json"))) {
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m17432w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m17427d(LOG_TAG, "Following redirect to: %s", url);
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(C5312rZ.m27869a("Invalid url: ", str), e);
        }
    }
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new Function() { // from class: com.google.android.datatransport.cct.a
                ...
                public final Object apply(Object obj) {
                    return this.f11017a.doSend((CctTransportBackend.HttpRequest) obj);
                }
            ...
            if (i == 200) {
                return BackendResponse.m17425ok(httpResponse.nextRequestMillis);
            }
            if (i < 500 && i != 404) {
            ...
            Logging.m17430e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
