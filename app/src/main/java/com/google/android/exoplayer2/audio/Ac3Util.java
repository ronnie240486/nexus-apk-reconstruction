...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW, 128, 160, PsExtractor.AUDIO_STREAM, 224, 256, TbsListener.ErrorCode.ERROR_SDKENGINE_INIT_THROWABLE, C4525iC.f14486j, 448, 512, 576, TbsListener.ErrorCode.STATIC_TBS_INSTALL_MAKE_SYMBOLIC_LINK_ERR};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, TbsListener.ErrorCode.THREAD_INIT_ERROR, CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA, 174, TbsListener.ErrorCode.EXCEED_DEXOPT_RETRY_NUM, 243, MediaPlayer.Event.f17416v, 348, TbsListener.ErrorCode.INFO_TEMP_CORE_EXIST_CONF_ERROR, C0727LD.f1762m, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static int parseAc3SyncframeSize(byte[] bArr) {
        ...
        if (((bArr[5] & 248) >> 3) > 10) {
            return (((bArr[3] & C1579YX.f3960d) | ((bArr[2] & 7) << 8)) + 1) * 2;
        }
        byte b = bArr[4];
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(ByteBuffer byteBuffer, int i) {
        return 40 << ((byteBuffer.get((byteBuffer.position() + i) + ((byteBuffer.get((byteBuffer.position() + i) + 7) & C1579YX.f3960d) == 187 ? 9 : 8)) >> 4) & 7);
    }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        if (bArr[4] == -8 && bArr[5] == 114 && bArr[6] == 111) {
            byte b = bArr[7];
            if ((b & 254) == 186) {
                return 40 << ((bArr[(b & C1579YX.f3960d) == 187 ? '\t' : '\b'] >> 4) & 7);
            }
        }
        return 0;
    }
