...
public final class SimpleCache implements Cache {
    ...
    private static long createUid(File file) throws IOException {
        ...
        File file2 = new File(file, C4515i2.m21289a(Long.toString(jAbs, 16), UID_FILE_SUFFIX));
        if (file2.createNewFile()) {
            return jAbs;
        }
        throw new IOException(C5259qj.m27705a("Failed to create UID file: ", file2));
    }
            ...
            if (databaseProvider != null) {
                ...
                if (jLoadUid != -1) {
                    try {
                        ...
                        Log.m17586w(TAG, "Failed to delete file metadata: " + jLoadUid);
                    }
                    try {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (name.endsWith(UID_FILE_SUFFIX)) {
                try {
                    ...
                    Log.m17582e(TAG, "Malformed UID file: " + file);
                    file.delete();
                }
            }
        }
    ...
    private void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                C4843mz.m22258a("Failed to remove file index entry for: ", name, TAG);
            }
        }
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m17586w(TAG, "Failed to update index with new touch timestamp.");
            }
            z = false;
        } else {
            z = true;
    ...
    public synchronized void commitFile(File file, long j) throws Cache.CacheException {
        ...
        if (file.exists()) {
            ...
            long jM4795a = C1071Qb.m4795a(cachedContent.getMetadata());
            if (jM4795a != -1) {
                Assertions.checkState(simpleCacheSpan.position + simpleCacheSpan.length <= jM4795a);
            }
            if (this.fileIndex == null) {
    ...
    public synchronized void release() {
        ...
        try {
            try {
                ...
                Log.m17583e(TAG, "Storing index file failed", e);
                unlockFolder(this.cacheDir);
            }
            this.released = true;
        } catch (Throwable th) {
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f11137id, j, System.currentTimeMillis());
    }
    ...
    public SimpleCache(File file, CacheEvictor cacheEvictor, CachedContentIndex cachedContentIndex, @Nullable CacheFileMetadataIndex cacheFileMetadataIndex) {
        if (!lockFolder(file)) {
            throw new IllegalStateException(C5259qj.m27705a("Another SimpleCache instance uses the folder: ", file));
        }
        this.cacheDir = file;
