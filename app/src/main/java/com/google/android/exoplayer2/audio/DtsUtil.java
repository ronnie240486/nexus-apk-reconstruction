...
public final class DtsUtil {
    ...
    private static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW, 128, PsExtractor.AUDIO_STREAM, 224, 256, C4525iC.f14486j, 448, 512, TbsListener.ErrorCode.STATIC_TBS_INSTALL_MAKE_SYMBOLIC_LINK_ERR, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static Format parseDtsFormat(byte[] bArr, String str, @Nullable String str2, @Nullable DrmInitData drmInitData) {
