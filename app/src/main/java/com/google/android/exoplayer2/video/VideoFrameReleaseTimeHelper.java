...
public final class VideoFrameReleaseTimeHelper {
    ...
    public static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C3219C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (i == 0) {
                ...
                this.sampledVsyncTimeNs = C3219C.TIME_UNSET;
            }
        }
    ...
    public long adjustReleaseTime(long j, long j2) {
        ...
        if (vSyncSampler == null || this.vsyncDurationNs == C3219C.TIME_UNSET) {
            return j3;
        }
        long j7 = vSyncSampler.sampledVsyncTimeNs;
        return j7 == C3219C.TIME_UNSET ? j3 : closestVsync(j3, j7, this.vsyncDurationNs) - this.vsyncOffsetNs;
    }
    ...
    public VideoFrameReleaseTimeHelper(@Nullable Context context) {
        ...
        this.vsyncDurationNs = C3219C.TIME_UNSET;
        this.vsyncOffsetNs = C3219C.TIME_UNSET;
    }
}
