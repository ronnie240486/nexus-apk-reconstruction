...
public final class VorbisBitArray {
    ...
    public boolean readBit() {
        boolean z = (((this.data[this.byteOffset] & C1579YX.f3960d) >> this.bitOffset) & 1) == 1;
        skipBits(1);
        return z;
    }
    ...
    public int readBits(int i) {
        ...
        int i3 = i2 + 1;
        int i4 = ((this.data[i2] & C1579YX.f3960d) >> this.bitOffset) & (255 >> (8 - iMin));
        while (iMin < i) {
            i4 |= (this.data[i3] & C1579YX.f3960d) << iMin;
            iMin += 8;
            i3++;
        }
        int i5 = i4 & ((-1) >>> (32 - i));
