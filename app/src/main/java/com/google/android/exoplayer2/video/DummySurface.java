            ...
            try {
                if (i != 1) {
                    ...
                    try {
                        ...
                        try {
                            Log.m17583e(DummySurface.TAG, "Failed to release dummy surface", th);
                        } finally {
                            quit();
                        }
                    }
                ...
                try {
                    ...
                    Log.m17583e(DummySurface.TAG, "Failed to initialize dummy surface", e);
                    this.initError = e;
                    synchronized (this) {
                        notify();
                    }
                } catch (RuntimeException e2) {
                    Log.m17583e(DummySurface.TAG, "Failed to initialize dummy surface", e2);
