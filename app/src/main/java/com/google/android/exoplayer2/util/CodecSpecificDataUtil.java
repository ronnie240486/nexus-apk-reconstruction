...
public final class CodecSpecificDataUtil {
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i, int i2) {
        ...
        if (i == -1 || i6 == -1) {
            throw new IllegalArgumentException(C2998bp.m14684a("Invalid sample rate or number of channels: ", i, ", ", i2));
        }
        ...
        if (z) {
            if (aacAudioObjectType != 1 && aacAudioObjectType != 2 && aacAudioObjectType != 3 && aacAudioObjectType != 4 && aacAudioObjectType != 6 && aacAudioObjectType != 7 && aacAudioObjectType != 17) {
                switch (aacAudioObjectType) {
                    ...
                    case 23:
                        break;
                    default:
                        throw new ParserException(C5630w2.m29215a("Unsupported audio object type: ", aacAudioObjectType));
                }
            }
            ...
            switch (aacAudioObjectType) {
                ...
                case 23:
                    ...
                    if (bits2 == 2 || bits2 == 3) {
                        throw new ParserException(C5630w2.m29215a("Unsupported epConfig: ", bits2));
                    }
                    break;
            }
        }
