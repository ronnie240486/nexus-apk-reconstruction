...
final class DashMediaPeriod implements MediaPeriod, SequenceableLoader.Callback<ChunkSampleStream<DashChunkSource>>, ChunkSampleStream.ReleaseCallback<DashChunkSource> {
    ...
    private static void buildManifestEventTrackGroupInfos(List<EventStream> list, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr, int i) {
        int i2 = 0;
        while (i2 < list.size()) {
            trackGroupArr[i] = new TrackGroup(Format.createSampleFormat(list.get(i2).m17557id(), MimeTypes.APPLICATION_EMSG, null, -1, null));
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(DrmSessionManager<?> drmSessionManager, List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, Format[][] formatArr, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i4 < i) {
            ...
            if (i8 != -1) {
                trackGroupArr[i8] = new TrackGroup(Format.createSampleFormat(C0978P9.m4377a(new StringBuilder(), adaptationSet.f11120id, ":emsg"), MimeTypes.APPLICATION_EMSG, null, -1, null));
        ...
        for (int i : iArr) {
            ...
            for (int i2 = 0; i2 < list2.size(); i2++) {
                ...
                if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri)) {
                    ...
                    if (str == null) {
                        return new Format[]{buildCea608TrackFormat(adaptationSet.f11120id)};
                    }
                    ...
                    for (int i3 = 0; i3 < strArrSplit.length; i3++) {
                        ...
                        formatArr[i3] = buildCea608TrackFormat(adaptationSet.f11120id, matcher.group(2), Integer.parseInt(matcher.group(1)));
                    }
                    return formatArr;
                }
            }
    ...
    private static int[][] getGroupedAdaptationSetIndices(List<AdaptationSet> list) {
        ...
        for (int i = 0; i < size; i++) {
            sparseIntArray.put(list.get(i).f11120id, i);
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (iMin == i2 && (descriptorFindAdaptationSetSwitchingProperty = findAdaptationSetSwitchingProperty(adaptationSet.supplementalProperties)) != null) {
                for (String str : Util.split(descriptorFindAdaptationSetSwitchingProperty.value, C1262Tc.f3278g)) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            int[] array = Util.toArray((List) arrayList.get(i4));
            iArr[i4] = array;
            Arrays.sort(array);
        }
        return iArr;
    ...
    public void updateManifest(DashManifest dashManifest, int i) {
        ...
        for (EventSampleStream eventSampleStream : this.eventSampleStreams) {
            for (EventStream eventStream : this.eventStreams) {
                if (eventStream.m17557id().equals(eventSampleStream.eventStreamId())) {
    ...
    private static Format buildCea608TrackFormat(int i, String str, int i2) {
        ...
        sb.append(i);
        sb.append(":cea608");
        sb.append(i2 != -1 ? C5630w2.m29215a(":", i2) : "");
