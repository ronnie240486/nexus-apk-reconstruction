    ...
    public static final class SchemeData implements Parcelable {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                ...
                this.hashCode = Arrays.hashCode(this.data) + C0372Fg.m1897a(this.mimeType, (iHashCode + (str == null ? 0 : str.hashCode())) * 31, 31);
            }
            return this.hashCode;
        }

        public boolean matches(UUID uuid) {
            return C3219C.UUID_NIL.equals(this.uuid) || uuid.equals(this.uuid);
        }
