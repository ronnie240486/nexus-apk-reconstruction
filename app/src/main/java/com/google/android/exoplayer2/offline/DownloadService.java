...
public abstract class DownloadService extends Service {
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                ...
                try {
                    ...
                    Log.m17586w(DownloadService.TAG, "Failed to restart DownloadService (process is idle).");
                }
            }
        }
        ...
        private void updateScheduler() {
            ...
            Log.m17582e(DownloadService.TAG, "Scheduling downloads failed.");
        }
            ...
            if (this.downloadManager.isInitialized()) {
                new Handler().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.c
                    ...
                    public final void run() {
                        this.f11100a.lambda$attachService$0(downloadService);
                    }
                });
            }
        }
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m17586w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        public /* synthetic */ void onDownloadsPausedChanged(DownloadManager downloadManager, boolean z) {
            C1075Qf.m4805c(this, downloadManager, z);
        }
        ...
        public /* synthetic */ void onRequirementsStateChanged(DownloadManager downloadManager, Requirements requirements, int i) {
            C1075Qf.m4808f(this, downloadManager, requirements, i);
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: com.google.android.exoplayer2.offline.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f11102a.update();
                    }
    ...
    public int onStartCommand(@Nullable Intent intent, int i, int i2) {
        ...
        switch (action) {
            ...
            case "com.google.android.exoplayer.downloadService.action.REMOVE_DOWNLOAD":
                ...
                break;
            default:
                strConcat = "Ignored unrecognized action: ".concat(action);
                Log.m17582e(TAG, strConcat);
                break;
        }
