...
public class ContainerMediaChunk extends BaseMediaChunk {
    ...
    public final void load() throws InterruptedException, IOException {
        if (this.nextLoadPosition == 0) {
            ...
            long j2 = j == C3219C.TIME_UNSET ? -9223372036854775807L : j - this.sampleOffsetUs;
            long j3 = this.clippedEndTimeUs;
            chunkExtractorWrapper.init(trackOutputProvider, j2, j3 == C3219C.TIME_UNSET ? -9223372036854775807L : j3 - this.sampleOffsetUs);
        }
        try {
