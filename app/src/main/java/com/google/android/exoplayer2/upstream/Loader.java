...
public final class Loader implements LoaderErrorThrower {
    ...
    public final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    Log.m17583e(TAG, "Unexpected exception handling load completed", e);
            ...
            if (loadErrorActionOnLoadError.type == 3) {
                ...
                start(loadErrorActionOnLoadError.retryDelayMillis != C3219C.TIME_UNSET ? loadErrorActionOnLoadError.retryDelayMillis : getRetryDelayMillis());
            }
        }
        ...
        public void run() {
            ...
            try {
                ...
                Log.m17583e(TAG, "Unexpected exception loading stream", e2);
                if (this.released) {
                    return;
                }
                ...
                Log.m17583e(TAG, "OutOfMemory error loading stream", e3);
                if (this.released) {
                    return;
                }
                ...
                Log.m17583e(TAG, "Unexpected error loading stream", e4);
                if (!this.released) {
    ...
    static {
        long j = C3219C.TIME_UNSET;
        RETRY = createRetryAction(false, C3219C.TIME_UNSET);
        RETRY_RESET_ERROR_COUNT = createRetryAction(true, C3219C.TIME_UNSET);
