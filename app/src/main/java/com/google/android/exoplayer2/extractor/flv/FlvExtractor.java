...
public final class FlvExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: Bl
    ...
    private void ensureReadyForMediaOutput() {
        ...
        this.extractorOutput.seekMap(new SeekMap.Unseekable(C3219C.TIME_UNSET));
    ...
    private long getCurrentTimestampUs() {
        ...
        if (this.metadataReader.getDurationUs() == C3219C.TIME_UNSET) {
            return 0L;
        }
    ...
    private boolean readTagData(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        if (i != 8 || this.audioReader == null) {
            if (i == 9 && this.videoReader != null) {
                ...
                if (durationUs != C3219C.TIME_UNSET) {
