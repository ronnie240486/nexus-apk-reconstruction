...
abstract class StreamReader {
    ...
    public static final class UnseekableOggSeeker implements OggSeeker {
        ...
        public SeekMap createSeekMap() {
            return new SeekMap.Unseekable(C3219C.TIME_UNSET);
        }
    ...
    public abstract boolean readHeaders(ParsableByteArray parsableByteArray, long j, SetupData setupData) throws InterruptedException, IOException;
