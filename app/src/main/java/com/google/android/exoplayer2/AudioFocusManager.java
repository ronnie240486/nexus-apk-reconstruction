...
final class AudioFocusManager {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.a
                ...
                public final void run() {
                    this.f11058a.lambda$onAudioFocusChange$0(i);
                }
            });
        }
    }
    ...
    private void abandonAudioFocusV26() {
        ...
        if (audioFocusRequest != null) {
            C5700x5.m29396a(this.audioManager, audioFocusRequest);
        }
    }
    ...
    private static int convertAudioAttributesToFocusGain(@Nullable AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            case 0:
                Log.m17586w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 15:
            default:
                Log.m17586w(TAG, "Unidentified audio usage: " + audioAttributes.usage);
                return 0;
            case 16:
    ...
    public void handlePlatformAudioFocusChange(int i) {
        ...
        if (i == -1) {
            ...
            C0208D5.m1307a("Unknown focus change type: ", i, TAG);
        } else {
