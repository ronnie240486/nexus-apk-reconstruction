...
final class Sniffer {
    ...
    private long readUint(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        int i2 = this.scratch.data[0] & C1579YX.f3960d;
        if (i2 == 0) {
        ...
        while (i < i4) {
            i++;
            i5 = (this.scratch.data[i] & C1579YX.f3960d) + (i5 << 8);
        }
    ...
    public boolean sniff(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        while (unsignedInt != 440786851) {
            ...
            extractorInput.peekFully(this.scratch.data, 0, 1);
            unsignedInt = ((unsignedInt << 8) & (-256)) | ((long) (this.scratch.data[0] & C1579YX.f3960d));
        }
