...
final class Sonic {
    ...
    private void changeSpeed(float f) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                ...
                if (d > 1.0d) {
                    iSkipPitchPeriod = iFindPitchPeriod + skipPitchPeriod(sArr, iSkipPitchPeriod, f, iFindPitchPeriod) + iSkipPitchPeriod;
                } else {
                    iInsertPitchPeriod = insertPitchPeriod(sArr, iSkipPitchPeriod, f, iFindPitchPeriod);
                }
            }
    ...
    private short interpolate(short[] sArr, int i, int i2, int i3) {
        short s2 = sArr[i];
        short s3 = sArr[i + this.channelCount];
        ...
        int i8 = i7 - i4;
        int i9 = i7 - i6;
        return (short) ((((i9 - i8) * s3) + (s2 * i8)) / i9);
    }
