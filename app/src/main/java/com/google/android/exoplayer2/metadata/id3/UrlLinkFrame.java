...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f11092id.equals(urlLinkFrame.f11092id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }
    ...
    public String toString() {
        return this.f11092id + ": url=" + this.url;
    }
