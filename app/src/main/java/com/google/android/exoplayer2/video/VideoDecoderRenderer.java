...
class VideoDecoderRenderer implements GLSurfaceView.Renderer, VideoDecoderOutputBufferRenderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        for (int i7 = 0; i7 < 3; i7++) {
            if (this.previousWidths[i7] != iArr[i7] || this.previousStrides[i7] != videoDecoderOutputBuffer2.yuvStrides[i7]) {
                Assertions.checkState(videoDecoderOutputBuffer2.yuvStrides[i7] != 0);
                ...
                this.previousWidths[i7] = iArr[i7];
                this.previousStrides[i7] = videoDecoderOutputBuffer2.yuvStrides[i7];
            }
        }
