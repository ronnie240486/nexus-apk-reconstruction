...
public final class Track {
    ...
    public Track copyWithFormat(Format format) {
        return new Track(this.f11075id, this.type, this.timescale, this.movieTimescale, this.durationUs, format, this.sampleTransformation, this.sampleDescriptionEncryptionBoxes, this.nalUnitLengthFieldLength, this.editListDurations, this.editListMediaTimes);
    }
