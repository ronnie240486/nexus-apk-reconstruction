...
public interface HttpDataSource extends DataSource {
    public static final Predicate<String> REJECT_PAYWALL_TYPES = new Predicate() { // from class: Vp
    ...
    public static final class InvalidContentTypeException extends HttpDataSourceException {
        ...
        public InvalidContentTypeException(String str, DataSpec dataSpec) {
            super(C5312rZ.m27869a("Invalid content type: ", str), dataSpec, 1);
    ...
    public static final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        public InvalidResponseCodeException(int i, @Nullable String str, Map<String, List<String>> map, DataSpec dataSpec) {
            super(C5630w2.m29215a("Response code: ", i), dataSpec, 1);
            this.responseCode = i;
