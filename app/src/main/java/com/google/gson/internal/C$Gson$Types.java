...
public final class C$Gson$Types {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return C$Gson$Types.typeToString(this.componentType) + C4375fq.f14035n;
        }
    }
        ...
        public String toString() {
            ...
            if (this.lowerBound != null) {
                ...
                if (this.upperBound == Object.class) {
                    return AbstractC4717l6.f14991e;
                }
    ...
    public static Class<?> getRawType(Type type) {
        ...
        throw new IllegalArgumentException("Expected a Class, ParameterizedType, or GenericArrayType, but <" + type + "> is of type " + (type == null ? AndroidLoggerFactory.f17234b : type.getClass().getName()));
    }
