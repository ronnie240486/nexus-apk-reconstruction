...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class C383736 {
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = C383736.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                    ...
                    if (i2 != 1) {
                        if (i2 == 2) {
                            ...
                            try {
                                ...
                                throw new JsonSyntaxException(C5312rZ.m27869a("Error: Expecting: bitset number value (1, 0), Found: ", strNextString));
                            }
                        }
        ...
        BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.gson.internal.bind.TypeAdapters.4
            ...
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
                jsonWriter.value(bool == null ? AndroidLoggerFactory.f17234b : bool.toString());
            }
        };
        ...
        TypeAdapter<Number> typeAdapter5 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken jsonTokenPeek = jsonReader.peek();
                int i = C383736.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                if (i == 1 || i == 3) {
        ...
        TypeAdapter<URL> typeAdapter10 = new TypeAdapter<URL>() { // from class: com.google.gson.internal.bind.TypeAdapters.21
            ...
            public URL read(JsonReader jsonReader) throws IOException {
                ...
                String strNextString = jsonReader.nextString();
                if (AndroidLoggerFactory.f17234b.equals(strNextString)) {
                    return null;
                }
        ...
        TypeAdapter<JsonElement> typeAdapter16 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (C383736.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + Marker.f17179z0 + cls2.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.33
            ...
            public String toString() {
                return "Factory[type=" + cls2.getName() + Marker.f17179z0 + cls.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
}
