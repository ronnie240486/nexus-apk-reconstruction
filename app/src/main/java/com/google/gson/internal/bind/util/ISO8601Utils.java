        ...
        try {
            ...
            if (zCheckOffset) {
                ...
                if (str.length() <= i13 || (cCharAt = str.charAt(i13)) == 'Z' || cCharAt == '+' || cCharAt == '-') {
                    ...
                    if (checkOffset(str, i15, FilenameUtils.f15632b)) {
                        int i16 = i13 + 3;
            ...
            if (cCharAt2 == 'Z') {
                ...
                if (cCharAt2 != '+' && cCharAt2 != '-') {
                    throw new IndexOutOfBoundsException("Invalid time zone indicator '" + cCharAt2 + C1313UP.f3457j);
                }
            ...
            if (str == null) {
                ...
                str2 = "\"" + str + C1002PX.f2511b;
            }
            message = e.getMessage();
            if (message != null || message.isEmpty()) {
                message = C1313UP.f3458k + e.getClass().getName() + C1313UP.f3459l;
            }
