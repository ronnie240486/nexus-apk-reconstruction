...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = {52, 289, 97, 352, 49, VodPlayFragment.f8485n3, TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW, 37, 292, 100, MediaPlayer.Event.f17406l, 73, 328, 25, 280, 88, 13, MediaPlayer.Event.f17409o, 76, 28, MediaPlayer.Event.f17402h, 67, TbsListener.ErrorCode.ERROR_GETSTRINGARRAY_JARFILE, 19, 274, 82, 7, MediaPlayer.Event.f17405k, 70, 22, 385, 193, 448, CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA, TbsListener.ErrorCode.INFO_CODE_BASE, TbsListener.ErrorCode.EXCEED_DEXOPT_RETRY_NUM, 133, 388, 196, CipherSuite.TLS_RSA_PSK_WITH_AES_128_CBC_SHA, 168, 162, 138, 42};
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (true) {
            ...
            if (cPatternToChar == '*') {
                ...
                float f = i;
                return new Result(this.extendedMode ? decodeExtended(sb) : sb.toString(), null, new ResultPoint[]{new ResultPoint((iArrFindAsteriskPattern[1] + iArrFindAsteriskPattern[0]) / 2.0f, f), new ResultPoint((i4 / 2.0f) + nextSet, f)}, BarcodeFormat.CODE_39);
            }
            nextSet = nextSet2;
        }
    }
