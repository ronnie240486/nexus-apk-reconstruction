...
public final class MonochromeRectangleDetector {
    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        ...
        while (i14 < i8 && i14 >= i7 && i13 < i4 && i13 >= i3) {
            ...
            int[] iArrBlackWhiteRange = blackWhiteRange(i10, i9, i11, i12, z);
            if (iArrBlackWhiteRange == null) {
                ...
                if (i2 == 0) {
                    ...
                    if (iArr[1] > i) {
                        return new ResultPoint(iArr[i6 <= 0 ? (char) 1 : (char) 0], i15);
                    }
                    return new ResultPoint(i16, i15);
                }
                int i17 = i13 - i2;
                int i18 = iArr[0];
                if (i18 >= i5) {
                ...
                if (iArr[1] > i5) {
                    return new ResultPoint(i17, iArr[i2 >= 0 ? (char) 1 : (char) 0]);
                }
                return new ResultPoint(i17, i18);
            }
            i14 += i6;
            i13 += i2;
