...
public final class Encoder {
    ...
    public static /* synthetic */ class C38631 {
    ...
    public static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C38631.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
    ...
    public static void appendKanjiBytes(String str, BitArray bitArray) throws WriterException {
        ...
        try {
            ...
            for (int i2 = 0; i2 < length; i2 += 2) {
                int i3 = ((bytes[i2] & C1579YX.f3960d) << 8) | (bytes[i2 + 1] & C1579YX.f3960d);
                int i4 = 33088;
    ...
    public static byte[] generateECBytes(byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            iArr[i2] = bArr[i2] & C1579YX.f3960d;
        }
    ...
    public static BitArray interleaveWithECBytes(BitArray bitArray, int i, int i2, int i3) throws WriterException {
        ...
        StringBuilder sbM27771a = C5274qy.m27771a("Interleaving error: ", i, " and ");
        sbM27771a.append(bitArray2.getSizeInBytes());
        sbM27771a.append(" differ.");
        throw new WriterException(sbM27771a.toString());
    }
