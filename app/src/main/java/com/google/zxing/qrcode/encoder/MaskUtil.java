...
final class MaskUtil {
    ...
    private static final int f11221N1 = 3;

    /* JADX INFO: renamed from: N2 */
    private static final int f11222N2 = 3;

    /* JADX INFO: renamed from: N3 */
    private static final int f11223N3 = 40;

    /* JADX INFO: renamed from: N4 */
    private static final int f11224N4 = 10;
    ...
    public static boolean getDataMaskBit(int i, int i2, int i3) {
        ...
        switch (i) {
            ...
            case 7:
                ...
                return false;
            default:
                throw new IllegalArgumentException(C5630w2.m29215a("Invalid mask pattern: ", i));
        }
    }
