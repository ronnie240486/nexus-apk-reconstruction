...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z) throws NotFoundException {
        ...
        if (listDetect.isEmpty()) {
            blackMatrix = blackMatrix.m30216clone();
                ...
                if (resultPointArrFindVertices[0] == null && resultPointArrFindVertices[3] == null) {
                    ...
                    for (ResultPoint[] resultPointArr : arrayList) {
                        ...
                        if (resultPoint2 != null) {
                            y = (int) Math.max(y, resultPoint2.getY());
                        }
                        ResultPoint resultPoint3 = resultPointArr[3];
                        if (resultPoint3 != null) {
                            y = Math.max(y, (int) resultPoint3.getY());
                        }
                    }
                    y += 5;
                } else {
                    ...
                    ResultPoint resultPoint4 = resultPointArrFindVertices[2];
                    if (resultPoint4 != null) {
                        x = (int) resultPoint4.getX();
