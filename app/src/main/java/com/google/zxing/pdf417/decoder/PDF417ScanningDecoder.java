...
import com.google.zxing.pdf417.decoder.p008ec.ErrorCorrection;
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, ChecksumException, FormatException {
        ...
        for (int i6 = 1; i6 <= barcodeColumnCount; i6++) {
            ...
            if (detectionResultMerge.getDetectionResultColumn(i7) == null) {
                DetectionResultColumn detectionResultRowIndicatorColumn = (i7 == 0 || i7 == barcodeColumnCount) ? new DetectionResultRowIndicatorColumn(boundingBox, i7 == 0) : new DetectionResultColumn(boundingBox);
                ...
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResultMerge, i7, minY, z);
                    ...
                    int i10 = minY;
                    Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i4, i10, iMin, iMax);
                    i3 = i10;
