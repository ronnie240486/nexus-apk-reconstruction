...
public class FirebaseCrashlytics {
    ...
    public static FirebaseCrashlytics init(@NonNull FirebaseApp firebaseApp, @NonNull FirebaseInstallationsApi firebaseInstallationsApi, @NonNull Deferred<CrashlyticsNativeComponent> deferred, @NonNull Deferred<AnalyticsConnector> deferred2) {
        ...
        Logger.getLogger().m17654i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        Logger.getLogger().m17650d("Mapping file ID is: " + mappingFileId);
        try {
            ...
            Logger.getLogger().m17656v("Installer package name is: " + appDataCreate.installerPackageName);
            ...
            settingsControllerCreate.loadSettingsData(executorServiceBuildSingleThreadExecutorService).continueWith(executorServiceBuildSingleThreadExecutorService, new Continuation<Void, Object>() { // from class: com.google.firebase.crashlytics.FirebaseCrashlytics.1
                ...
                public Object then(@NonNull Task<Void> task) throws Exception {
                    ...
                    Logger.getLogger().m17653e("Error fetching settings.", task.getException());
                    return null;
                }
            });
            ...
            Logger.getLogger().m17653e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(@NonNull Throwable th) {
        if (th == null) {
            Logger.getLogger().m17658w("A null value was passed to recordException. Ignoring.");
        } else {
