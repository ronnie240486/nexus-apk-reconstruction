...
public class SettingsController implements SettingsProvider {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson != null) {
                        ...
                        if (SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) || !settingsJson.isExpired(currentTimeMillis)) {
                            try {
                                Logger.getLogger().m17656v("Returning cached settings.");
                                settings = settingsJson;
                            } catch (Exception e) {
                                e = e;
                                settings = settingsJson;
                                Logger.getLogger().m17653e("Failed to get cached settings", e);
                            }
                        } else {
                            Logger.getLogger().m17656v("Cached settings have expired.");
                        }
                    } else {
                        Logger.getLogger().m17653e("Failed to parse cached settings data.", null);
                    }
                } else {
                    Logger.getLogger().m17650d("No cached settings data found.");
                }
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        sbM1657a.append(jSONObject.toString());
        logger.m17650d(sbM1657a.toString());
    }
