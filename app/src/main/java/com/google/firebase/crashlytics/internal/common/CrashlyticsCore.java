...
public class CrashlyticsCore {
    ...
    private void checkForPreviousCrash() {
        boolean zEquals;
        try {
            zEquals = Boolean.TRUE.equals((Boolean) Utils.awaitEvenIfOnMainThread(this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.4
        ...
        this.didCrashOnPreviousExecution = zEquals;
    }
    ...
    public Task<Void> doBackgroundInitialization(SettingsProvider settingsProvider) {
        ...
        try {
            this.breadcrumbSource.registerBreadcrumbHandler(new BreadcrumbHandler(this) { // from class: Hc

                /* JADX INFO: renamed from: a */
                public final /* synthetic */ CrashlyticsCore f1103a;
            ...
            if (!settingsProvider.getSettingsSync().featureFlagData.collectReports) {
                Logger.getLogger().m17650d("Collection of crash reports disabled in Crashlytics settings.");
                return Tasks.forException(new RuntimeException("Collection of crash reports disabled in Crashlytics settings."));
            }
            if (!this.controller.finalizeSessions(settingsProvider)) {
                Logger.getLogger().m17658w("Previous sessions could not be finalized.");
            }
            return this.controller.submitAllReports(settingsProvider.getSettingsAsync());
        } catch (Exception e) {
            Logger.getLogger().m17653e("Crashlytics encountered a problem during asynchronous initialization.", e);
    ...
    private void finishInitSynchronously(final SettingsProvider settingsProvider) {
        ...
        Logger.getLogger().m17650d("Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously.");
        try {
    ...
    public static boolean isBuildIdValid(String str, boolean z) {
        if (!z) {
            Logger.getLogger().m17656v("Configured not to require a build ID.");
            return true;
        }
    ...
    public void logFatalException(Throwable th) {
        Logger.getLogger().m17650d("Recorded on-demand fatal events: " + this.onDemandCounter.getRecordedOnDemandExceptions());
        Logger.getLogger().m17650d("Dropped on-demand fatal events: " + this.onDemandCounter.getDroppedOnDemandExceptions());
        ...
        this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.3
            ...
            public Boolean call() throws Exception {
                try {
                    ...
                    if (!zRemove) {
                        Logger.getLogger().m17658w("Initialization marker file was not properly removed.");
                    }
                    return Boolean.valueOf(zRemove);
                } catch (Exception e) {
                    Logger.getLogger().m17653e("Problem encountered deleting Crashlytics initialization marker.", e);
    ...
    public void markInitializationStarted() {
        ...
        Logger.getLogger().m17656v("Initialization marker file was created.");
    }
    ...
    public boolean onPreExecute(AppData appData, SettingsProvider settingsProvider) {
        ...
        try {
            ...
            if (!zDidPreviousInitializationFail || !CommonUtils.canTryConnection(this.context)) {
                Logger.getLogger().m17650d("Successfully configured exception handler.");
                return true;
            }
            Logger.getLogger().m17650d("Crashlytics did not finish previous background initialization. Initializing synchronously.");
            finishInitSynchronously(settingsProvider);
            return false;
        } catch (Exception e) {
            Logger.getLogger().m17653e("Crashlytics was not started due to an exception during initialization", e);
