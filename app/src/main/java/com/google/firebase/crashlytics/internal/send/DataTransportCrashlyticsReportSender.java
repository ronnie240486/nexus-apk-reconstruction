...
public class DataTransportCrashlyticsReportSender {
    ...
    private static final Transformer<CrashlyticsReport, byte[]> DEFAULT_TRANSFORM = new Transformer() { // from class: pd
    ...
    public static DataTransportCrashlyticsReportSender create(Context context, SettingsProvider settingsProvider, OnDemandCounter onDemandCounter) {
        ...
        Encoding encodingM17421of = Encoding.m17421of("json");
        Transformer<CrashlyticsReport, byte[]> transformer = DEFAULT_TRANSFORM;
        return new DataTransportCrashlyticsReportSender(new ReportQueue(transportFactoryNewFactory.getTransport(CRASHLYTICS_TRANSPORT_NAME, CrashlyticsReport.class, encodingM17421of, transformer), settingsProvider.getSettingsSync(), onDemandCounter), transformer);
    }
