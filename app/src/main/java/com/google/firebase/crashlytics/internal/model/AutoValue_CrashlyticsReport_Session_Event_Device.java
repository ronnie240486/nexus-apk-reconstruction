...
final class AutoValue_CrashlyticsReport_Session_Event_Device extends CrashlyticsReport.Session.Event.Device {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Device.Builder {
        ...
        public CrashlyticsReport.Session.Event.Device build() {
            String strM21289a = this.batteryVelocity == null ? " batteryVelocity" : "";
            if (this.proximityOn == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " proximityOn");
            }
            if (this.orientation == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " orientation");
            }
            if (this.ramUsed == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " ramUsed");
            }
            if (this.diskUsed == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " diskUsed");
            }
    ...
    public String toString() {
        ...
        sb.append(", diskUsed=");
        return C1026Pv.m4564a(sb, this.diskUsed, "}");
    }
}
