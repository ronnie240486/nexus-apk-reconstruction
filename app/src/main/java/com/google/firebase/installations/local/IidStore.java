...
public class IidStore {
    ...
    private static String getIdFromPublicKey(@NonNull PublicKey publicKey) {
        try {
            ...
            bArrDigest[0] = (byte) (((bArrDigest[0] & SAXEventRecorder.SAXEvent.f16649r) + TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW) & 255);
    ...
    private PublicKey parseKey(String str) {
        try {
            return KeyFactory.getInstance(C5236qM.f18515e).generatePublic(new X509EncodedKeySpec(Base64.decode(str, 8)));
