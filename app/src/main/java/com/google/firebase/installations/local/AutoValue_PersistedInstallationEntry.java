...
final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public PersistedInstallationEntry build() {
            String strM21289a = this.registrationStatus == null ? " registrationStatus" : "";
            if (this.expiresInSecs == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " expiresInSecs");
            }
            if (this.tokenCreationEpochInSecs == null) {
                strM21289a = C4515i2.m21289a(strM21289a, " tokenCreationEpochInSecs");
            }
    ...
    public String toString() {
        ...
        sb.append(", fisError=");
        return C0786MA.m3668a(sb, this.fisError, "}");
    }
}
