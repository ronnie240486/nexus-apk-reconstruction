...
public class FirebaseApp {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (C1205Sk.m5687a(INSTANCE, null, globalBackgroundStateListener)) {
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (C1205Sk.m5687a(INSTANCE, null, userUnlockReceiver)) {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime componentRuntimeBuild = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m17632of(context, Context.class, new Class[0])).addComponent(Component.m17632of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m17632of(firebaseOptions, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor()).build();
        this.componentRuntime = componentRuntimeBuild;
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider(this, context) { // from class: Qk

            /* JADX INFO: renamed from: a */
            public final /* synthetic */ FirebaseApp f2803a;
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener(this) { // from class: Rk

            /* JADX INFO: renamed from: a */
            public final /* synthetic */ FirebaseApp f2990a;
    ...
    public String getPersistenceKey() {
        return Base64Utils.encodeUrlSafeNoPadding(getName().getBytes(Charset.defaultCharset())) + Marker.f17179z0 + Base64Utils.encodeUrlSafeNoPadding(getOptions().getApplicationId().getBytes(Charset.defaultCharset()));
    }
    ...
    public static String getPersistenceKey(String str, FirebaseOptions firebaseOptions) {
        return Base64Utils.encodeUrlSafeNoPadding(str.getBytes(Charset.defaultCharset())) + Marker.f17179z0 + Base64Utils.encodeUrlSafeNoPadding(firebaseOptions.getApplicationId().getBytes(Charset.defaultCharset()));
    }
