...
public abstract class DSABase extends SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    public byte[] engineSign() throws java.security.SignatureException {
        ...
        L20:
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jce.provider.DSABase.engineSign():byte[]");
    }
    ...
    public boolean engineVerify(byte[] r5) throws java.security.SignatureException {
        ...
        L20:
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jce.provider.DSABase.engineVerify(byte[]):boolean");
    }
}
