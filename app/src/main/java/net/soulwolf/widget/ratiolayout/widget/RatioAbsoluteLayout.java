...
public class RatioAbsoluteLayout extends AbsoluteLayout implements RatioMeasureDelegate {
    ...
    /* JADX WARN: Invalid debug info offset */
    public RatioAbsoluteLayout(Context context, AttributeSet attributeSet, int i) {
    }

    /* JADX WARN: Invalid debug info offset */
    @TargetApi(21)
    public RatioAbsoluteLayout(Context context, AttributeSet attributeSet, int i, int i2) {
    }
