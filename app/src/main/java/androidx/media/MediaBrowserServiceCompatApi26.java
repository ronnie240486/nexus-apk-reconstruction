...
class MediaBrowserServiceCompatApi26 {
    ...
    public static class ResultWrapper {
        ...
        public void sendResult(List<Parcel> list, int i) {
            ...
            C0836My.m3903a(this.mResultObj, parcelListToItemList(list));
        }
    }
    ...
    static {
        try {
            Field declaredField = C1029Py.m4571a().getDeclaredField("mFlags");
    ...
    public static Bundle getBrowserRootHints(Object obj) {
        return C1094Qy.m4880a(C0453Gy.m2226a(obj));
    }

    public static void notifyChildrenChanged(Object obj, String str, Bundle bundle) {
        C1156Ry.m5416a(C0453Gy.m2226a(obj), str, bundle);
    }
}
