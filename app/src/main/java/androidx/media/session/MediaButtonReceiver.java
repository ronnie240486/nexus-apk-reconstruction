...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    private static ComponentName getServiceComponentByAction(Context context, String str) {
        ...
        StringBuilder sbM6151a = C1288U1.m6151a("Expected 1 service that handles ", str, ", found ");
        sbM6151a.append(listQueryIntentServices.size());
        throw new IllegalStateException(sbM6151a.toString());
    }
