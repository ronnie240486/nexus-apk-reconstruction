...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z, int i, int i2) {
        ...
        switch (i2) {
            ...
            default:
                if (z) {
                    throw new IllegalArgumentException(C5954f00.m20225a("Unknown usage value ", i2, " in audio attributes"));
                }
                return 3;
        }
    }
    ...
    public static String usageToString(int i) {
        switch (i) {
            ...
            case 15:
            default:
                return C5630w2.m29215a("unknown usage ", i);
            case 16:
    ...
    public static AudioAttributesCompat wrap(@NonNull Object obj) {
        ...
        AudioAttributesImplApi21 audioAttributesImplApi21 = new AudioAttributesImplApi21(C5219q5.m27591a(obj));
