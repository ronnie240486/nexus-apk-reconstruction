...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi28 extends MediaBrowserServiceImplApi26 {
        ...
        public MediaSessionManager.RemoteUserInfo getCurrentBrowserInfo() {
            ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mCurConnection;
            return connectionRecord != null ? connectionRecord.browserInfo : new MediaSessionManager.RemoteUserInfo(C0517Hy.m2438a(C0453Gy.m2226a(this.mServiceObj)));
        }
    }
    ...
    @Override // android.app.Service
    public void onCreate() {
        MediaBrowserServiceImpl mediaBrowserServiceImplApi21;
        super.onCreate();
        int i = Build.VERSION.SDK_INT;
        if (i >= 28) {
            mediaBrowserServiceImplApi21 = new MediaBrowserServiceImplApi28();
        } else if (i >= 26) {
            mediaBrowserServiceImplApi21 = new MediaBrowserServiceImplApi26();
        } else if (i >= 23) {
            mediaBrowserServiceImplApi21 = new MediaBrowserServiceImplApi23();
        } else {
            mediaBrowserServiceImplApi21 = i >= 21 ? new MediaBrowserServiceImplApi21() : new MediaBrowserServiceImplBase();
        }
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C0849NA.m3929a(new StringBuilder("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C5312rZ.m27869a("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C5312rZ.m27869a("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
