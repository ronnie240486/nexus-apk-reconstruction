...
public class MonotonicCurveFit extends CurveFit {
    ...
    private double[] f10074mT;
    private double[][] mTangent;

    /* JADX INFO: renamed from: mY */
    private double[][] f10075mY;
    ...
    public double getPos(double d, int i) {
        double[] dArr = this.f10074mT;
        int length = dArr.length;
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f10075mY[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f10075mY[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f10074mT;
            double d2 = dArr2[i2];
            if (d == d2) {
                return this.f10075mY[i2][i];
            }
            int i4 = i2 + 1;
            double d3 = dArr2[i4];
            if (d < d3) {
    ...
    public void getPos(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f10075mY[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f10075mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        int i4 = 0;
        while (i4 < i3) {
            if (d == this.f10074mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f10075mY[i4][i5];
                }
            }
            double[] dArr3 = this.f10074mT;
            int i6 = i4 + 1;
            double d2 = dArr3[i6];
            if (d < d2) {
                double d3 = dArr3[i4];
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f10075mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            while (i < length2) {
                fArr[i] = (float) this.f10075mY[i3][i];
                i++;
            }
            return;
        }
        ...
        while (i4 < i3) {
            if (d == this.f10074mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f10075mY[i4][i5];
                }
            }
            double[] dArr2 = this.f10074mT;
            int i6 = i4 + 1;
