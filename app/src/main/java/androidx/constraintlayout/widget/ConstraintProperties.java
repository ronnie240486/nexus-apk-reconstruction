...
public class ConstraintProperties {
    ...
    /* JADX WARN: Code duplicated, block: B:18:0x002c A[PHI: r0 r1
        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(C0786MA.m3668a(new StringBuilder("Left to "), sideToString(i3), " undefined"));
                    }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(C0786MA.m3668a(new StringBuilder("right to "), sideToString(i3), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(C0786MA.m3668a(sb, sideToString(i3), " unknown"));
        }
    }
