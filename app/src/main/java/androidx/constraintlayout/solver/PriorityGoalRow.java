...
public class PriorityGoalRow extends ArrayRow {
    ...
    public class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f10082id - ((SolverVariable) obj).f10082id;
        }
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i = 0; i < 9; i++) {
                    ...
                    sbM1657a.append(this.variable.goalStrengthVector[i]);
                    sbM1657a.append(" ");
                    string = sbM1657a.toString();
                }
            }
            StringBuilder sbM3902a = C0835Mx.m3902a(string, "] ");
            sbM3902a.append(this.variable);
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i3].f10082id > solverVariable.f10082id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f10082id - solverVariable3.f10082id;
                }
            });
    ...
    public SolverVariable getPivotCandidate(LinearSystem linearSystem, boolean[] zArr) {
        ...
        for (int i2 = 0; i2 < this.numGoals; i2++) {
            ...
            if (!zArr[solverVariable.f10082id]) {
                this.accessor.init(solverVariable);
