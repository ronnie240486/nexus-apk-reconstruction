...
public class ArrayRow implements LinearSystem.Row {
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                ...
                if ((zArr == null || !zArr[variable.f10082id]) && variable != solverVariable && (((type = variable.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
    ...
    public String toReadableString() {
        boolean z;
        String str;
        String strM21289a = C4515i2.m21289a(this.variable == null ? "0" : "" + this.variable, " = ");
        if (this.constantValue != 0.0f) {
            StringBuilder sbM1657a = C0305Ec.m1657a(strM21289a);
            sbM1657a.append(this.constantValue);
                ...
                if (variableValue != 0.0f) {
                    ...
                    if (z) {
                        if (variableValue > 0.0f) {
                            ...
                            str = " - ";
                            strM21289a = C4515i2.m21289a(strM21289a, str);
                            variableValue *= -1.0f;
                        }
                    ...
                    strM21289a = variableValue == 1.0f ? C4515i2.m21289a(strM21289a, string) : strM21289a + variableValue + " " + string;
                    z = true;
                }
            }
        }
        return !z ? C4515i2.m21289a(strM21289a, IdManager.DEFAULT_VERSION_NAME) : strM21289a;
    }
