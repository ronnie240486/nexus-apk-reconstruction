...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f10082id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i3 = iArr2[i2];
        if (i3 == -1) {
            iArr2[i2] = i;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.variables[i] = solverVariable.f10082id;
        this.values[i] = f;
        this.previous[i] = -1;
        this.next[i] = -1;
        ...
        for (int i = 0; i < this.HASH_SIZE; i++) {
            if (this.keys[i] != -1) {
                ...
                while (!z) {
                    ...
                    sbM3902a.append(this.variables[i2]);
    ...
    private void removeFromHashMap(SolverVariable solverVariable) {
        int[] iArr;
        int i;
        int i2 = solverVariable.f10082id;
    ...
    public void put(SolverVariable solverVariable, float f) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            ...
            int i6 = solverVariable.f10082id;
            if (i5 == i6) {
                this.values[i2] = f;
                return;
            }
    ...
    public String toString() {
        String strM21289a;
        String strM21289a2;
        String strM21289a3 = hashCode() + " { ";
        int i = this.mCount;
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str = strM21289a3 + variable + " = " + getVariableValue(i2) + " ";
                int iIndexOf = indexOf(variable);
                String strM21289a4 = C4515i2.m21289a(str, "[p: ");
                if (this.previous[iIndexOf] != -1) {
                    StringBuilder sbM1657a = C0305Ec.m1657a(strM21289a4);
                    sbM1657a.append(this.mCache.mIndexedVariables[this.variables[this.previous[iIndexOf]]]);
                    strM21289a = sbM1657a.toString();
                } else {
                    strM21289a = C4515i2.m21289a(strM21289a4, "none");
                }
                String strM21289a5 = C4515i2.m21289a(strM21289a, ", n: ");
                if (this.next[iIndexOf] != -1) {
                    StringBuilder sbM1657a2 = C0305Ec.m1657a(strM21289a5);
                    sbM1657a2.append(this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]]);
                    strM21289a2 = sbM1657a2.toString();
                } else {
                    strM21289a2 = C4515i2.m21289a(strM21289a5, "none");
                }
                strM21289a3 = C4515i2.m21289a(strM21289a2, "]");
            }
        }
        return C4515i2.m21289a(strM21289a3, " }");
    }
