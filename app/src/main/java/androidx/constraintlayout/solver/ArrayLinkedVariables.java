...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z) {
        ...
        if (f <= (-f2) || f >= f2) {
            ...
            if (i == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f10082id;
            ...
            this.mArrayIndices[length] = solverVariable.f10082id;
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            if (this.mArrayIndices[i] == solverVariable.f10082id) {
                return true;
            }
            i = this.mArrayNextIndices[i];
        }
    ...
    public String toString() {
        ...
        String string = "";
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            StringBuilder sbM1657a = C0305Ec.m1657a(C4515i2.m21289a(string, " -> "));
            sbM1657a.append(this.mArrayValues[i]);
            sbM1657a.append(" : ");
            StringBuilder sbM1657a2 = C0305Ec.m1657a(sbM1657a.toString());
            sbM1657a2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
