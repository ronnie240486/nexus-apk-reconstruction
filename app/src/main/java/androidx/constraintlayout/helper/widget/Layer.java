...
public class Layer extends ConstraintHelper {
    ...
    public void onAttachedToWindow() {
        ...
        if (this.mApplyVisibilityOnAttach || this.mApplyElevationOnAttach) {
            ...
            float fM3334a = Build.VERSION.SDK_INT >= 21 ? C0704Ku.m3334a(this) : 0.0f;
            for (int i = 0; i < this.mCount; i++) {
                ...
                if (viewById != null) {
                    ...
                    if (this.mApplyElevationOnAttach && fM3334a > 0.0f && Build.VERSION.SDK_INT >= 21) {
                        C0832Mu.m3895a(viewById, C0769Lu.m3612a(viewById) + fM3334a);
                    }
                }
            }
        }
