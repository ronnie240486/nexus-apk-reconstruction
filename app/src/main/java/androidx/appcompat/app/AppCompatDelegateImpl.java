...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C2439R.attr.homeAsUpIndicator});
    ...
    public static class Api21Impl {
        ...
        public static boolean isPowerSaveMode(PowerManager powerManager) {
            return C4778m3.m22042a(powerManager);
        }
    }
    ...
    public static class Api24Impl {
        ...
        public static void generateConfigDelta_locale(@NonNull Configuration configuration, @NonNull Configuration configuration2, @NonNull Configuration configuration3) {
            LocaleList localeListM22540a = C4905nw.m22540a(configuration);
            LocaleList localeListM22540a2 = C4905nw.m22540a(configuration2);
            if (C4848n3.m22275a(localeListM22540a, localeListM22540a2)) {
                return;
            }
            C4913o3.m22578a(configuration3, localeListM22540a2);
    ...
    public static class Api26Impl {
        ...
        public static void generateConfigDelta_colorMode(@NonNull Configuration configuration, @NonNull Configuration configuration2, @NonNull Configuration configuration3) {
            if ((C5154p3.m27363a(configuration) & 3) != (C5154p3.m27363a(configuration2) & 3)) {
                C5217q3.m27587a(configuration3, C5154p3.m27363a(configuration3) | (C5154p3.m27363a(configuration2) & 3));
            }
            if ((C5154p3.m27363a(configuration) & 12) != (C5154p3.m27363a(configuration2) & 12)) {
                C5217q3.m27587a(configuration3, C5154p3.m27363a(configuration3) | (C5154p3.m27363a(configuration2) & 12));
            }
        }
    }
    ...
    public static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C2439R.layout.abc_list_menu_item_layout);
        ...
        public void setStyle(Context context) {
            ...
            themeNewTheme.resolveAttribute(C2439R.attr.actionBarPopupTheme, typedValue, true);
            int i = typedValue.resourceId;
            if (i != 0) {
                themeNewTheme.applyStyle(i, true);
            }
            themeNewTheme.resolveAttribute(C2439R.attr.panelMenuListTheme, typedValue, true);
            int i2 = typedValue.resourceId;
            if (i2 == 0) {
                i2 = C2439R.style.Theme_AppCompat_CompactMenu;
            }
            themeNewTheme.applyStyle(i2, true);
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(themeNewTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray typedArrayObtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C2439R.styleable.AppCompatTheme);
            this.background = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C2439R.styleable.AppCompatTheme);
        typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (typedArrayObtainStyledAttributes.hasValue(C2439R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C2439R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C2439R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C2439R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            typedArrayObtainStyledAttributes.getValue(C2439R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C2439R.styleable.AppCompatTheme);
        if (!typedArrayObtainStyledAttributes.hasValue(C2439R.styleable.AppCompatTheme_windowActionBar)) {
            typedArrayObtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AppCompatTheme_android_windowIsFloating, false);
        typedArrayObtainStyledAttributes.recycle();
        ensureWindow();
        this.mWindow.getDecorView();
        LayoutInflater layoutInflaterFrom = LayoutInflater.from(this.mContext);
        if (this.mWindowNoTitle) {
            viewGroup = (ViewGroup) layoutInflaterFrom.inflate(this.mOverlayActionMode ? C2439R.layout.abc_screen_simple_overlay_action_mode : C2439R.layout.abc_screen_simple, (ViewGroup) null);
        } else if (this.mIsFloating) {
            viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C2439R.layout.abc_dialog_title_material, (ViewGroup) null);
            this.mOverlayActionBar = false;
            this.mHasActionBar = false;
        } else if (this.mHasActionBar) {
            TypedValue typedValue = new TypedValue();
            this.mContext.getTheme().resolveAttribute(C2439R.attr.actionBarTheme, typedValue, true);
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(C2439R.layout.abc_screen_toolbar, (ViewGroup) null);
            DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C2439R.id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C2439R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C2439R.id.action_bar_activity_content);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((i == 0 || i == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C2439R.attr.actionBarTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                themeNewTheme = context.getResources().newTheme();
                themeNewTheme.setTo(theme);
                themeNewTheme.applyStyle(typedValue.resourceId, true);
                themeNewTheme.resolveAttribute(C2439R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C2439R.attr.actionBarWidgetTheme, typedValue, true);
                themeNewTheme = null;
            }
            if (typedValue.resourceId != 0) {
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f10057x, panelFeatureState.f10058y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            i = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f10057x, panelFeatureState.f10058y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            ...
            i = C2439R.color.abc_decor_view_status_guard_light;
        } else {
            context = this.mContext;
            i = C2439R.color.abc_decor_view_status_guard;
        }
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C2439R.style.Theme_AppCompat_Empty);
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C2439R.styleable.AppCompatTheme).getString(C2439R.styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(contextThemeWrapper, (AttributeSet) null, C2439R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = popupWindow;
                    PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    contextThemeWrapper.getTheme().resolveAttribute(C2439R.attr.actionBarSize, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C2439R.id.action_mode_bar_stub);
