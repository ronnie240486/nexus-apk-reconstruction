...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2439R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2439R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2439R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C2439R.styleable.AlertDialog, C2439R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2;
        Runnable runnable;
        final View viewFindViewById = this.mWindow.findViewById(C2439R.id.scrollIndicatorUp);
        final View viewFindViewById2 = this.mWindow.findViewById(C2439R.id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C2439R.id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C2439R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            viewFindViewById = this.mWindow.findViewById(C2439R.id.title_template);
        } else {
            this.mIconView = (ImageView) this.mWindow.findViewById(R.id.icon);
            if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
                TextView textView = (TextView) this.mWindow.findViewById(C2439R.id.alertTitle);
            ...
            this.mWindow.findViewById(C2439R.id.title_template).setVisibility(8);
            this.mIconView.setVisibility(8);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C2439R.id.parentPanel);
        View viewFindViewById4 = viewFindViewById3.findViewById(C2439R.id.topPanel);
        View viewFindViewById5 = viewFindViewById3.findViewById(C2439R.id.contentPanel);
        View viewFindViewById6 = viewFindViewById3.findViewById(C2439R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C2439R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(C2439R.id.topPanel);
        View viewFindViewById8 = viewGroup.findViewById(C2439R.id.contentPanel);
        View viewFindViewById9 = viewGroup.findViewById(C2439R.id.buttonPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C2439R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            viewFindViewById = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C2439R.id.titleDividerNoCustom);
            if (viewFindViewById != null) {
                viewFindViewById.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C2439R.id.textSpacerNoTitle)) != null) {
            viewFindViewById.setVisibility(0);
        }
        ListView listView = this.mListView;
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C2439R.attr.alertDialogCenterButtons, typedValue, true);
