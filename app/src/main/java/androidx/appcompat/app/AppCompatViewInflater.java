...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            if (id == -1) {
                ...
                str = " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(id) + C1313UP.f3457j;
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2439R.styleable.View, 0, 0);
        int resourceId = z ? typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.View_theme, 0)) != 0) {
