...
class StateListDrawable extends DrawableContainer {
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C2470R.styleable.StateListDrawableItem);
                int resourceId = typedArrayObtainAttributes.getResourceId(C2470R.styleable.StateListDrawableItem_android_drawable, -1);
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            stateListState.mChangingConfigurations |= C0778M2.m3641a(typedArray);
        }
        stateListState.mVariablePadding = typedArray.getBoolean(C2470R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C2470R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C2470R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C2470R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C2470R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C2470R.styleable.StateListDrawable);
        setVisible(typedArrayObtainAttributes.getBoolean(C2470R.styleable.StateListDrawable_android_visible, true), true);
