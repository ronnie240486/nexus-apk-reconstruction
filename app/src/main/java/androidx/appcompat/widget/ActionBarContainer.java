...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C2439R.id.action_bar);
        this.mContextView = findViewById(C2439R.id.action_context_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (isCollapsed(this.mActionBarView)) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(measuredHeightWithMargins + getMeasuredHeightWithMargins(this.mTabContainer), size));
        }
        view = this.mActionBarView;
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2439R.styleable.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C2439R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.ActionBar_backgroundSplit);
        }
