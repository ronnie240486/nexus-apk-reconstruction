...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C2439R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C2439R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbM27771a = C5274qy.m27771a("Invalid icon resource ", iconResource, " for ");
            sbM27771a.append(componentName.flattenToShortString());
            string = sbM27771a.toString();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C2439R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
