            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                if (Build.VERSION.SDK_INT >= 25 && (i & 1) != 0) {
                    try {
                        ...
                        InputContentInfo inputContentInfoM28112a = C5351s3.m28112a(inputContentInfoCompat.unwrap());
                        bundle = bundle == null ? new Bundle() : new Bundle(bundle);
                        bundle.putParcelable(AppCompatReceiveContentHelper.EXTRA_INPUT_CONTENT_INFO, inputContentInfoM28112a);
                    } catch (Exception e) {
