...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C2439R.layout.abc_action_bar_title_item, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(C2439R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C2439R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        if (view != null) {
            ...
            View viewFindViewById = this.mClose.findViewById(C2439R.id.action_mode_close_button);
        ...
        addView(viewInflate);
        View viewFindViewById2 = this.mClose.findViewById(C2439R.id.action_mode_close_button);
        this.mCloseButton = viewFindViewById2;
        viewFindViewById2.setOnClickListener(new View.OnClickListener() { // from class: androidx.appcompat.widget.ActionBarContextView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                actionMode.finish();
            }
        ...
        ActionMenuPresenter actionMenuPresenter3 = new ActionMenuPresenter(getContext());
        this.mActionMenuPresenter = actionMenuPresenter3;
        actionMenuPresenter3.setReserveOverflow(true);
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2439R.attr.actionModeStyle);
    }

    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C2439R.styleable.ActionMode, i, 0);
        ViewCompat.setBackground(this, tintTypedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.ActionMode_background));
        this.mTitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = tintTypedArrayObtainStyledAttributes.getLayoutDimension(C2439R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = tintTypedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.ActionMode_closeItemLayout, C2439R.layout.abc_action_mode_close_item_material);
