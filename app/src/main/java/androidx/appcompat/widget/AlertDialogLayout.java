...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C2439R.id.topPanel) {
                    view = childAt;
                } else if (id == C2439R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != C2439R.id.contentPanel && id != C2439R.id.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i8 = gravity & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                setChildFrame(childAt, i6, i13, measuredWidth, measuredHeight2);
