...
class TooltipPopup {
    ...
    public TooltipPopup(@NonNull Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C2439R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C2439R.id.message);
        ...
        layoutParams.windowAnimations = C2439R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C2439R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C2439R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C2439R.dimen.tooltip_y_offset_touch : C2439R.dimen.tooltip_y_offset_non_touch);
        ...
        if (rect.left < 0 && rect.top < 0) {
            ...
            int identifier = resources.getIdentifier("status_bar_height", "dimen", C0353FN.f780a);
