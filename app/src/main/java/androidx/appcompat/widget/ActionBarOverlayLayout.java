...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C2439R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C2439R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C2439R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C2439R.id.action_bar));
        }
    }
