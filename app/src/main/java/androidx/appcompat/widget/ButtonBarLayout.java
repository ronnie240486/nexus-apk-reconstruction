...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2439R.styleable.ButtonBarLayout);
        ViewCompat.saveAttributeDataForStyleable(this, context, C2439R.styleable.ButtonBarLayout, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        this.mAllowStacking = typedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        ...
        View viewFindViewById = findViewById(C2439R.id.spacer);
