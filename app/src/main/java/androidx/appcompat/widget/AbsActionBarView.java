...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C2439R.styleable.ActionBar, C2439R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C2439R.styleable.ActionBar_height, 0));
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C2439R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
