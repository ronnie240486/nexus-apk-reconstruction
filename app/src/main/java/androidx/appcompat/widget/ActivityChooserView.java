...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                ...
                View viewInflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C2439R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                viewInflate.setId(1);
                ((TextView) viewInflate.findViewById(C2439R.id.title)).setText(ActivityChooserView.this.getContext().getString(C2439R.string.abc_activity_chooser_view_see_all));
                return viewInflate;
            }
            if (view == null || view.getId() != C2439R.id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C2439R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ImageView imageView = (ImageView) view.findViewById(C2439R.id.icon);
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            imageView.setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C2439R.id.title)).setText(resolveInfo.loadLabel(packageManager));
    ...
    public void showPopupUnchecked(int i) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C2439R.string.abc_activitychooserview_choose_application));
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2439R.styleable.ActivityChooserView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C2439R.styleable.ActivityChooserView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        this.mInitialActivityCount = typedArrayObtainStyledAttributes.getInt(C2439R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        typedArrayObtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C2439R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View viewFindViewById = findViewById(C2439R.id.activity_chooser_view_content);
        this.mActivityChooserContent = viewFindViewById;
        this.mActivityChooserContentBackground = viewFindViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C2439R.id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C2439R.id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C2439R.id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C2439R.id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C2439R.dimen.abc_config_prefDialogWidth));
    }
}
