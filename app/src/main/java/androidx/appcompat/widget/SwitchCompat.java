...
public class SwitchCompat extends CompoundButton {
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(C2439R.string.abc_capital_off);
            }
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(C2439R.string.abc_capital_on);
            }
            ViewCompat.setStateDescription(this, string);
        }
    }
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C2439R.styleable.TextAppearance_android_textColor);
        if (colorStateList == null) {
            colorStateList = getTextColors();
        }
        this.mTextColors = colorStateList;
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(C2439R.styleable.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.getInt(C2439R.styleable.TextAppearance_android_textStyle, -1));
        this.mSwitchTransformationMethod = tintTypedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.TextAppearance_textAllCaps, false) ? new AllCapsTransformationMethod(getContext()) : null;
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2439R.attr.switchStyle);
    }
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C2439R.styleable.SwitchCompat, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C2439R.styleable.SwitchCompat, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i, 0);
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = tintTypedArrayObtainStyledAttributes.getDrawable(C2439R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        this.mTextOn = tintTypedArrayObtainStyledAttributes.getText(C2439R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = tintTypedArrayObtainStyledAttributes.getText(C2439R.styleable.SwitchCompat_android_textOff);
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C2439R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(C2439R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C2439R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C2439R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(C2439R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C2439R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C2439R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
