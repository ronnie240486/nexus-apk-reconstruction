...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C2439R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C2439R.dimen.abc_config_prefDialogWidth));
    ...
    private int getNextMenuPosition(int i) {
        ListView listView = ((CascadingMenuInfo) C2935ap.m14540a(this.mShowingMenus, 1)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) C2935ap.m14540a(this.mShowingMenus, 1);
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(C2439R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) C2935ap.m14540a(this.mShowingMenus, 1)).getListView();
    }
