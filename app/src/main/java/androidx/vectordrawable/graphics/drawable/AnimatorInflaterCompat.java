...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder sbM27771a = C5274qy.m27771a("Keyframe ", i, ": fraction ");
            float fraction = keyframe.getFraction();
            Object value = AndroidLoggerFactory.f17234b;
            sbM27771a.append(fraction < 0.0f ? AndroidLoggerFactory.f17234b : Float.valueOf(keyframe.getFraction()));
            sbM27771a.append(", , value : ");
            if (keyframe.hasValue()) {
                value = keyframe.getValue();
            }
            sbM27771a.append(value);
            Log.d(TAG, sbM27771a.toString());
        }
    }
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long namedInt = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, C5984j00.f14672z, 1, 300);
