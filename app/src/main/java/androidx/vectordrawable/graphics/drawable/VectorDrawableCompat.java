...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                sbM1657a.append(pathDataNodeArr[i].mType);
                sbM1657a.append(":");
                string = sbM1657a.toString();
                for (float f : pathDataNodeArr[i].mParams) {
                    StringBuilder sbM1657a2 = C0305Ec.m1657a(string);
                    sbM1657a2.append(f);
                    sbM1657a2.append(C1262Tc.f3278g);
                    string = sbM1657a2.toString();
                }
            }
            return string;
        }
        ...
        public void printVPath(int i) {
            ...
            StringBuilder sbM3902a = C0835Mx.m3902a(strM21289a, "current path is :");
            sbM3902a.append(this.mPathName);
            sbM3902a.append(" pathData is ");
            sbM3902a.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbM3902a.toString());
        }
    ...
    public static class VectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        @Override // android.graphics.drawable.Drawable.ConstantState
        public boolean canApplyTheme() {
            return C1289U2.m6153a(this.mDelegateState);
        }
        ...
        public Drawable newDrawable() {
            ...
            vectorDrawableCompat.mDelegateDrawable = C6012n00.m22262a(this.mDelegateState.newDrawable());
        ...
        public Drawable newDrawable(Resources resources) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = C6012n00.m22262a(this.mDelegateState.newDrawable(resources));
            return vectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = C6012n00.m22262a(C1353V2.m6436a(this.mDelegateState, resources, theme));
            return vectorDrawableCompat;
        }
    }
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder sbM3902a = C0835Mx.m3902a(strM21289a, "current group is :");
        sbM3902a.append(vGroup.getGroupName());
        sbM3902a.append(" rotation is ");
        sbM3902a.append(vGroup.mRotate);
        Log.v(LOGTAG, sbM3902a.toString());
        Log.v(LOGTAG, strM21289a + "matrix is :" + vGroup.getLocalMatrix().toString());
        for (int i3 = 0; i3 < vGroup.mChildren.size(); i3++) {
            VObject vObject = vGroup.mChildren.get(i3);
            if (vObject instanceof VGroup) {
