...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static class AnimatedVectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            AnimatedVectorDrawableCompat animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            Drawable drawableM6436a = C1353V2.m6436a(this.mDelegateState, resources, theme);
            animatedVectorDrawableCompat.mDelegateDrawable = drawableM6436a;
            drawableM6436a.setCallback(animatedVectorDrawableCompat.mCallback);
            return animatedVectorDrawableCompat;
        }
    }
    ...
    public static void registerAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            registerPlatformCallback(C0841N2.m3915a(drawable), animationCallback);
        } else {
    ...
    private static void registerPlatformCallback(@NonNull AnimatedVectorDrawable animatedVectorDrawable, @NonNull Animatable2Compat.AnimationCallback animationCallback) {
        C1098R2.m4922a(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }
    ...
    public static boolean unregisterAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        ...
        return Build.VERSION.SDK_INT >= 24 ? unregisterPlatformCallback(C0841N2.m3915a(drawable), animationCallback) : ((AnimatedVectorDrawableCompat) drawable).unregisterAnimationCallback(animationCallback);
    }
    ...
    private static boolean unregisterPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        return C1224T2.m5740a(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }
    ...
    public void clearAnimationCallbacks() {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            C1161S2.m5422a(C0841N2.m3915a(drawable));
            return;
        }
    ...
    public boolean isRunning() {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? C0971P2.m4367a(C0841N2.m3915a(drawable)) : this.mAnimatedVectorState.mAnimatorSet.isRunning();
    }
    ...
    public void start() {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            C1034Q2.m4578a(C0841N2.m3915a(drawable));
        } else {
            if (this.mAnimatedVectorState.mAnimatorSet.isStarted()) {
                return;
            }
    ...
    public void stop() {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            C0904O2.m4076a(C0841N2.m3915a(drawable));
        } else {
    ...
    public boolean unregisterAnimationCallback(@NonNull Animatable2Compat.AnimationCallback animationCallback) {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            unregisterPlatformCallback(C0841N2.m3915a(drawable), animationCallback);
        }
        ArrayList<Animatable2Compat.AnimationCallback> arrayList = this.mAnimationCallbacks;
