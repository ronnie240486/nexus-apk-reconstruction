...
class FragmentStateManager {
    ...
    public static /* synthetic */ class C27132 {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(C0786MA.m3668a(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int i = C27132.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i != 1) {
            if (i == 2) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbM27771a = C5274qy.m27771a("computeExpectedState() of ", iMin, " for ");
            sbM27771a.append(this.mFragment);
    ...
    public void createView() {
        ...
        if (view != null) {
            ...
            Fragment fragment5 = this.mFragment;
            fragment5.mView.setTag(C2664R.id.fragment_container_view_tag, fragment5);
            if (viewGroup != null) {
                addViewToContainer();
            }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C2664R.id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
    ...
    public FragmentStateManager(@NonNull FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, @NonNull FragmentStore fragmentStore, @NonNull ClassLoader classLoader, @NonNull FragmentFactory fragmentFactory, @NonNull FragmentState fragmentState) {
        ...
        fragmentInstantiate.mSavedFragmentState = bundle2 == null ? new Bundle() : bundle2;
        if (FragmentManager.isLoggingEnabled(2)) {
