...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    private static boolean hasSimpleTarget(Transition transition) {
        return (FragmentTransitionImpl.isNullOrEmpty(transition.getTargetIds()) && FragmentTransitionImpl.isNullOrEmpty(C0950Ol.m4330a(transition)) && FragmentTransitionImpl.isNullOrEmpty(C1016Pl.m4481a(transition))) ? false : true;
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            int iM4814a = C1081Ql.m4814a(transitionSet);
            while (i < iM4814a) {
                addTargets(C1143Rl.m5350a(transitionSet, i), arrayList);
                i++;
            }
            return;
        }
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            int iM4814a = C1081Ql.m4814a(transitionSet);
            while (i < iM4814a) {
                replaceTargets(C1143Rl.m5350a(transitionSet, i), arrayList, arrayList2);
                i++;
            }
            return;
        }
    ...
    public void setEpicenter(Object obj, final Rect rect) {
        if (obj != null) {
            C1206Sl.m5688a((Transition) obj, new Transition.EpicenterCallback() { // from class: androidx.fragment.app.FragmentTransitionCompat21.5
    ...
    public void setEpicenter(Object obj, View view) {
        if (view != null) {
            ...
            C1206Sl.m5688a((Transition) obj, new Transition.EpicenterCallback() { // from class: androidx.fragment.app.FragmentTransitionCompat21.1
                @Override // android.transition.Transition.EpicenterCallback
                public Rect onGetEpicenter(Transition transition) {
                    return rect;
                }
