...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    private static boolean isFragmentPostponed(FragmentTransaction.C2715Op c2715Op) {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C2715Op c2715Op = this.mOps.get(i2);
                Fragment fragment = c2715Op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(TAG, "Bump nesting of " + c2715Op.mFragment + " to " + c2715Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    public int commitInternal(boolean z) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            ...
            dump(OutputFormat.f16582n, printWriter);
            printWriter.close();
        }
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C2715Op c2715Op = this.mOps.get(i);
            Fragment fragment = c2715Op.mFragment;
            if (fragment != null) {
            ...
            switch (c2715Op.mCmd) {
                case 1:
                    fragment.setAnimations(c2715Op.mEnterAnim, c2715Op.mExitAnim, c2715Op.mPopEnterAnim, c2715Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c2715Op.mCmd);
                case 3:
                    fragment.setAnimations(c2715Op.mEnterAnim, c2715Op.mExitAnim, c2715Op.mPopEnterAnim, c2715Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c2715Op.mCurrentMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c2715Op.mCmd != 1 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C2715Op c2715Op = this.mOps.get(size);
            Fragment fragment = c2715Op.mFragment;
            if (fragment != null) {
            ...
            switch (c2715Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c2715Op.mOldMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c2715Op.mCmd != 3 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    public Fragment expandOps(ArrayList<Fragment> arrayList, Fragment fragment) {
        ...
        while (i < this.mOps.size()) {
            ...
            int i2 = c2715Op.mCmd;
            if (i2 == 1) {
                arrayList.add(c2715Op.mFragment);
            } else if (i2 == 2) {
                Fragment fragment3 = c2715Op.mFragment;
                    ...
                    if (fragment4.mContainerId == i3) {
                        if (fragment4 == fragment3) {
                            ...
                            if (fragment4 == fragment2) {
                                this.mOps.add(i, new FragmentTransaction.C2715Op(9, fragment4));
                                i++;
                                fragment2 = null;
                            }
                            FragmentTransaction.C2715Op c2715Op2 = new FragmentTransaction.C2715Op(3, fragment4);
                            c2715Op2.mEnterAnim = c2715Op.mEnterAnim;
                            c2715Op2.mPopEnterAnim = c2715Op.mPopEnterAnim;
                            c2715Op2.mExitAnim = c2715Op.mExitAnim;
                            c2715Op2.mPopExitAnim = c2715Op.mPopExitAnim;
                            this.mOps.add(i, c2715Op2);
                ...
                arrayList.remove(c2715Op.mFragment);
                Fragment fragment5 = c2715Op.mFragment;
                if (fragment5 == fragment2) {
                    this.mOps.add(i, new FragmentTransaction.C2715Op(9, fragment5));
                    i++;
                    fragment2 = null;
                }
            } else if (i2 == 7) {
                ...
                this.mOps.add(i, new FragmentTransaction.C2715Op(9, fragment2));
                i++;
                fragment2 = c2715Op.mFragment;
            }
            i++;
        }
        return fragment2;
    ...
    public void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener onStartEnterTransitionListener) {
        for (int i = 0; i < this.mOps.size(); i++) {
            FragmentTransaction.C2715Op c2715Op = this.mOps.get(i);
            if (isFragmentPostponed(c2715Op)) {
                c2715Op.mFragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
            }
        }
    }
            ...
            if (i == 1) {
                ...
                switch (i) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        fragment = c2715Op.mFragment;
                        break;
                    case 10:
                        c2715Op.mCurrentMaxState = c2715Op.mOldMaxState;
                        break;
                }
            } else {
                arrayList.add(c2715Op.mFragment);
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            printWriter.print(" ");
            printWriter.println(c2715Op.mFragment);
            if (z) {
                if (c2715Op.mEnterAnim != 0 || c2715Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c2715Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c2715Op.mExitAnim));
                }
                if (c2715Op.mPopEnterAnim != 0 || c2715Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c2715Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c2715Op.mPopExitAnim));
                }
            }
        }
    }
