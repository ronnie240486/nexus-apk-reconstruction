...
class FragmentAnim {
                ...
                public void onAnimationEnd(Animation animation) {
                    viewGroup.post(new Runnable() { // from class: androidx.fragment.app.FragmentAnim.2.1
                        ...
                        public void run() {
                            if (fragment.getAnimatingAway() != null) {
                                fragment.setAnimatingAway(null);
                                AnimationAnimationListenerC26942 animationAnimationListenerC26942 = AnimationAnimationListenerC26942.this;
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z, boolean z2) {
        ...
        if (viewGroup != null && viewGroup.getTag(C2664R.id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C2664R.id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C2664R.animator.fragment_open_enter : C2664R.animator.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C2664R.animator.fragment_fade_enter : C2664R.animator.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C2664R.animator.fragment_close_enter : C2664R.animator.fragment_close_exit;
    }
}
