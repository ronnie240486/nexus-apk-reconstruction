...
public final class FragmentContainerView extends FrameLayout {
    ...
    public WindowInsets dispatchApplyWindowInsets(@NonNull WindowInsets windowInsets) {
        ...
        WindowInsetsCompat windowInsetsCompat2 = onApplyWindowInsetsListener != null ? WindowInsetsCompat.toWindowInsetsCompat(C0886Nl.m4035a(onApplyWindowInsetsListener, this, windowInsets)) : ViewCompat.onApplyWindowInsets(this, windowInsetsCompat);
    ...
    public FragmentContainerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2664R.styleable.FragmentContainerView);
            if (classAttribute == null) {
                classAttribute = typedArrayObtainStyledAttributes.getString(C2664R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2664R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(C2664R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(C2664R.styleable.FragmentContainerView_android_tag);
        typedArrayObtainStyledAttributes.recycle();
        int id = getId();
        ...
        if (classAttribute != null && fragmentFindFragmentById == null) {
            if (id <= 0) {
                throw new IllegalStateException(C0060Av.m278a("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? " with tag ".concat(string) : ""));
            }
