...
public abstract class FragmentTransaction {
    ...
    public static final class C2715Op {
        int mCmd;
        ...
        public C2715Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        public C2715Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public void addOp(C2715Op c2715Op) {
        this.mOps.add(c2715Op);
        c2715Op.mEnterAnim = this.mEnterAnim;
        c2715Op.mExitAnim = this.mExitAnim;
        c2715Op.mPopEnterAnim = this.mPopEnterAnim;
        c2715Op.mPopExitAnim = this.mPopExitAnim;
    }
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                if (this.mSharedElementTargetNames.contains(str)) {
                    throw new IllegalArgumentException(C0060Av.m278a("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
                if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(C0060Av.m278a("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
            }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (str != null) {
            ...
            if (str2 != null && !str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(C0849NA.m3929a(sb, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i != 0) {
        ...
        addOp(new C2715Op(i2, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C2715Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C2715Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C2715Op(8, fragment));
        return this;
    }
