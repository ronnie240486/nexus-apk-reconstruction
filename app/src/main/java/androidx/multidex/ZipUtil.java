...
final class ZipUtil {
    ...
    public static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & C0321Es.f727k;
                centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & C0321Es.f727k;
    ...
    public static long getZipCrc(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, Tailer.f15848j);
        try {
