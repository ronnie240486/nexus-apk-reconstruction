...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo30213clone = transition.mo30213clone();
        transitionMo30213clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo30213clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo30213clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo30213clone);
    }
    ...
    public static void m14527go(@NonNull Scene scene) {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo30213clone = transition.mo30213clone();
        sceneChangeSetup(viewGroup, transitionMo30213clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo30213clone);
    }

    /* JADX INFO: renamed from: go */
    public static void m14528go(@NonNull Scene scene, @Nullable Transition transition) {
