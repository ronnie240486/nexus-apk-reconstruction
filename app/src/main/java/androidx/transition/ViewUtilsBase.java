...
class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C2881R.id.save_non_transition_alpha, null);
        }
    }

    public float getTransitionAlpha(@NonNull View view) {
        Float f = (Float) view.getTag(C2881R.id.save_non_transition_alpha);
        float alpha = view.getAlpha();
        return f != null ? alpha / f.floatValue() : alpha;
    }

    public void saveNonTransitionAlpha(@NonNull View view) {
        if (view.getTag(C2881R.id.save_non_transition_alpha) == null) {
            view.setTag(C2881R.id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        Float f2 = (Float) view.getTag(C2881R.id.save_non_transition_alpha);
        if (f2 != null) {
