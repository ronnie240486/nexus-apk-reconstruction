...
public class TransitionSet extends Transition {
    ...
    public Transition mo30213clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo30213clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo30213clone());
        }
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            if (i != 1) {
                throw new AndroidRuntimeException(C5630w2.m29215a("Invalid parameter for TransitionSet ordering: ", i));
            }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder sbM3902a = C0835Mx.m3902a(string, IOUtils.f15646e);
            sbM3902a.append(this.mTransitions.get(i).toString(str + OutputFormat.f16582n));
