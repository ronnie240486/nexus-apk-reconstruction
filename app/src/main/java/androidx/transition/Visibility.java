...
public abstract class Visibility extends Transition {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x0084, code lost:
        ...
        if (r0.mStartParent == null) goto L27;
     */
    /* JADX WARN: Code restructure failed: missing block: B:40:0x0092, code lost:
    
        if (r0.mStartVisibility == 0) goto L24;
     */
    /*
    ...
    */
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        visibilityInfo.mEndParent = viewGroup;
    ...
    public Animator onDisappear(final ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        ...
        final View view4 = (View) view3.getTag(C2881R.id.save_overlay_view);
        if (view4 != null) {
            view2 = null;
            z2 = true;
        } else {
