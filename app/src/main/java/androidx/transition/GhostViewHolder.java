...
class GhostViewHolder extends FrameLayout {
    ...
    public GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(C2881R.id.ghost_view_holder, this);
        ViewGroupUtils.getOverlay(this.mParent).add(this);
        this.mAttached = true;
    }

    public static GhostViewHolder getHolder(@NonNull ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(C2881R.id.ghost_view_holder);
    }
    ...
    private static boolean isOnTop(View view, View view2) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && C6028p20.m27362a(view) != C6028p20.m27362a(view2)) {
            return C6028p20.m27362a(view) > C6028p20.m27362a(view2);
        }
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(C2881R.id.ghost_view_holder, null);
