...
class ViewGroupUtilsApi14 {
    ...
    private static void cancelLayoutTransition(LayoutTransition layoutTransition) {
        if (!sCancelMethodFetched) {
            try {
                Method declaredMethod = LayoutTransition.class.getDeclaredMethod(C1715aZ.f4286e, null);
        ...
        if (z) {
            ...
            if (layoutTransition3 != null) {
                ...
                if (layoutTransition3 != sEmptyLayoutTransition) {
                    viewGroup.setTag(C2881R.id.transition_layout_save, layoutTransition3);
                }
            }
            ...
            layoutTransition = (LayoutTransition) viewGroup.getTag(C2881R.id.transition_layout_save);
            if (layoutTransition == null) {
                return;
            } else {
                viewGroup.setTag(C2881R.id.transition_layout_save, null);
            }
        }
