...
class ViewUtils {
    ...
    static {
        ViewUtilsBase viewUtilsApi21;
        int i = Build.VERSION.SDK_INT;
        if (i >= 29) {
            viewUtilsApi21 = new ViewUtilsApi29();
        } else if (i >= 23) {
            viewUtilsApi21 = new ViewUtilsApi23();
        } else if (i >= 22) {
            viewUtilsApi21 = new ViewUtilsApi22();
        } else {
            viewUtilsApi21 = i >= 21 ? new ViewUtilsApi21() : new ViewUtilsApi19();
        }
        IMPL = viewUtilsApi21;
