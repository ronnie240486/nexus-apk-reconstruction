...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        int i2 = this.mSize;
        if (i > i2) {
            StringBuilder sbM27771a = C5274qy.m27771a("cannot add item to ", i, " because size is ");
            sbM27771a.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        ...
        StringBuilder sbM27771a = C5274qy.m27771a("Asked to get item at ", i, " but size is ");
        sbM27771a.append(this.mSize);
        throw new IndexOutOfBoundsException(sbM27771a.toString());
    }
