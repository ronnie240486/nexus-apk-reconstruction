...
class ViewBoundsCheck {
    ...
    static final int f10122GT = 1;

    /* JADX INFO: renamed from: LT */
    static final int f10123LT = 4;
    ...
    public static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i2 & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW) != 0 && (i2 & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                return false;
            }
