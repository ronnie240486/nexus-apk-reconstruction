...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        while (i10 < this.mSpanCount && layoutState.hasMore(state) && spanIndex > 0) {
            ...
            if (spanSize > this.mSpanCount) {
                throw new IllegalArgumentException(C0978P9.m4377a(C1469Wn.m6925a("Item at position ", i11, " requires ", spanSize, " spans but GridLayoutManager has only "), this.mSpanCount, " spans."));
            }
            spanIndex -= spanSize;
    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanIndex2, spanSize2, spanIndex, spanSize, z, z2));
    }
    ...
    public void setSpanCount(int i) {
        ...
        if (i < 1) {
            throw new IllegalArgumentException(C5630w2.m29215a("Span count should be at least 1. Provided ", i));
        }
        this.mSpanCount = i;
        this.mSpanSizeLookup.invalidateSpanIndexCache();
        requestLayout();
