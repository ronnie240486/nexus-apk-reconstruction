...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public void assignFromViewAndKeepVisibleRect(View view, int i) {
            ...
            if (this.mLayoutFromEnd) {
                ...
                int iMin2 = decoratedMeasurement - (Math.min(this.mOrientationHelper.getDecoratedStart(view) - startAfterPadding, 0) + startAfterPadding);
                if (iMin2 >= 0) {
                    return;
                }
                iMin = Math.min(endAfterPadding, -iMin2) + this.mCoordinate;
            } else {
                ...
                if (endAfterPadding2 >= 0) {
                    ...
                    iMin = this.mCoordinate - Math.min(startAfterPadding2, -endAfterPadding2);
                }
            }
            this.mCoordinate = iMin;
        }
        ...
        public String toString() {
            return "AnchorInfo{mPosition=" + this.mPosition + ", mCoordinate=" + this.mCoordinate + ", mLayoutFromEnd=" + this.mLayoutFromEnd + ", mValid=" + this.mValid + MessageFormatter.f17214b;
        }
    }
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(C5630w2.m29215a("invalid orientation:", i));
        }
