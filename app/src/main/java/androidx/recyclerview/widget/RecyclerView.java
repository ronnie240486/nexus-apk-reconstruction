...
import androidx.recyclerview.C2796R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(C0991PM.m4393a(this.mRecyclerView, sb));
                }
                if (iIndexOfChild != i) {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2796R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C2796R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C2796R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C2796R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C2796R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(C0991PM.m4393a(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder sbM6925a = C1469Wn.m6925a("Inconsistency detected. Invalid item position ", i, "(offset:", iFindPositionOffset, ").state:");
                sbM6925a.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sbM6925a));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder sbM27771a = C5274qy.m27771a("invalid position ", i, ". State item count is ");
            sbM27771a.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sbM27771a));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (iIndexOfChild == -1) {
                ...
                throw new IllegalStateException(C0991PM.m4393a(RecyclerView.this, sb));
            }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, sb));
            }
            if (viewHolder.isTmpDetached()) {
                StringBuilder sb2 = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(viewHolder);
                throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, sb2));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        /* JADX WARN: Code duplicated, block: B:107:0x01f7 A[ADDED_TO_REGION] */
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (i < 0 || i >= RecyclerView.this.mState.getItemCount()) {
                StringBuilder sbM6925a = C1469Wn.m6925a("Invalid item position ", i, C1313UP.f3458k, i, "). Item count:");
                sbM6925a.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sbM6925a));
            }
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                if (childViewHolder == null) {
                    ...
                    if (iFindPositionOffset >= 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                        StringBuilder sbM6925a2 = C1469Wn.m6925a("Inconsistency detected. Invalid item position ", i, "(offset:", iFindPositionOffset, ").state:");
                        sbM6925a2.append(RecyclerView.this.mState.getItemCount());
                        throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sbM6925a2));
                    }
                    ...
                    if (childViewHolder == null && (viewCacheExtension = this.mViewCacheExtension) != null && (viewForPositionAndType = viewCacheExtension.getViewForPositionAndType(this, i, itemViewType)) != null) {
                        ...
                        if (childViewHolder == null) {
                            throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, new StringBuilder("getViewForPositionAndType returned a view which does not have a ViewHolder")));
                        }
                        if (childViewHolder.shouldIgnore()) {
                            throw new IllegalArgumentException(C0991PM.m4393a(RecyclerView.this, new StringBuilder("getViewForPositionAndType returned a view that is ignored. You must call stopIgnoring before returning this view.")));
                        }
                    }
                    if (childViewHolder == null) {
            ...
            if (childViewHolder == null) {
                ...
                StringBuilder sbM6925a3 = C1469Wn.m6925a("Inconsistency detected. Invalid item position ", i, "(offset:", iFindPositionOffset, ").state:");
                sbM6925a3.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sbM6925a3));
            }
            viewHolder = childViewHolder;
            z3 = z2;
            if (z3) {
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                throw new IndexOutOfBoundsException(C0991PM.m4393a(RecyclerView.this, sb));
            }
    ...
    public static class State {
        ...
        public String toString() {
            return "State{mTargetPosition=" + this.mTargetPosition + ", mData=" + this.mData + ", mItemCount=" + this.mItemCount + ", mIsMeasuring=" + this.mIsMeasuring + ", mPreviousLayoutItemCount=" + this.mPreviousLayoutItemCount + ", mDeletedInvisibleItemCountSincePreviousLayout=" + this.mDeletedInvisibleItemCountSincePreviousLayout + ", mStructureChanged=" + this.mStructureChanged + ", mInPreLayout=" + this.mInPreLayout + ", mRunSimpleAnimations=" + this.mRunSimpleAnimations + ", mRunPredictiveAnimations=" + this.mRunPredictiveAnimations + MessageFormatter.f17214b;
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sbM3902a = C0835Mx.m3902a(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            sbM3902a.append(Integer.toHexString(hashCode()));
            sbM3902a.append(" position=");
            sbM3902a.append(this.mPosition);
            sbM3902a.append(" id=");
            sbM3902a.append(this.mItemId);
            sbM3902a.append(", oldPos=");
            sbM3902a.append(this.mOldPosition);
            sbM3902a.append(", pLpos:");
            sbM3902a.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(sbM3902a.toString());
            if (isScrap()) {
                sb.append(" scrap ");
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + C1313UP.f3459l);
            }
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return RecyclerView.class.getPackage().getName() + FilenameUtils.f15632b + str;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(C0991PM.m4393a(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(C0991PM.m4393a(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        sb.append(i);
        throw new IllegalArgumentException(C0991PM.m4393a(this, sb));
    }
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(C0991PM.m4393a(this, C0305Ec.m1657a(str)));
        }
        throw new IllegalStateException(C0991PM.m4393a(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(C0991PM.m4393a(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(C0991PM.m4393a(this, new StringBuilder(""))));
        }
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(C0991PM.m4393a(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(C0991PM.m4393a(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
        Resources resources = getContext().getResources();
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C2796R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C2796R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C2796R.dimen.fastscroll_margin));
    }
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x00da A[PHI: r0
      0x00da: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00c5, B:46:0x00d6] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // android.view.View
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (scrollByInternal(zCanScrollHorizontally ? i4 : 0, zCanScrollVertically ? i7 : 0, motionEvent)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(C0991PM.m4393a(layoutManager.mRecyclerView, sb));
            }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2796R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2796R.styleable.RecyclerView, i, 0);
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 29) {
            C0925OM.m4251a(this, context, C2796R.styleable.RecyclerView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        }
        String string = typedArrayObtainStyledAttributes.getString(C2796R.styleable.RecyclerView_layoutManager);
        if (typedArrayObtainStyledAttributes.getInt(C2796R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(C2796R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C2796R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C2796R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C2796R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C2796R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C2796R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        typedArrayObtainStyledAttributes.recycle();
        ...
        if (i2 >= 21) {
            ...
            if (i2 >= 29) {
                C0925OM.m4251a(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes2, i, 0);
            }
