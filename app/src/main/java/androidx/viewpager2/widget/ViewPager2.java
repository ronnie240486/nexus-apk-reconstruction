...
import androidx.viewpager2.C2916R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2916R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            R20.m4923a(this, context, C2916R.styleable.ViewPager2, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(typedArrayObtainStyledAttributes.getInt(C2916R.styleable.ViewPager2_android_orientation, 0));
        } finally {
