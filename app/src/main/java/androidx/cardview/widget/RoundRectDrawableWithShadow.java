...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C2536R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C2536R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C2536R.dimen.cardview_compat_inset_shadow);
