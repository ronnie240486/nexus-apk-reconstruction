...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(C0245Dg.m1419a(ring.getStartingEndTrim() - MIN_PROGRESS_ARC, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(C0245Dg.m1419a(fFloor, ring.getStartingRotation(), f, ring.getStartingRotation()));
    }
