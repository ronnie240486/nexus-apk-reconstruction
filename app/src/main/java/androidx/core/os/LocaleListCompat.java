...
public final class LocaleListCompat {
    ...
    public static Locale forLanguageTagCompat(String str) {
        ...
        throw new IllegalArgumentException(C0060Av.m278a("Can not parse language tag: [", str, "]"));
    }
    ...
    public static LocaleListCompat forLanguageTags(@Nullable String str) {
        ...
        String[] strArrSplit = str.split(C1262Tc.f3278g, -1);
        int length = strArrSplit.length;
        Locale[] localeArr = new Locale[length];
        for (int i = 0; i < length; i++) {
            localeArr[i] = Build.VERSION.SDK_INT >= 21 ? C0396G3.m1985a(strArrSplit[i]) : forLanguageTagCompat(strArrSplit[i]);
        }
    ...
    public static LocaleListCompat getAdjustedDefault() {
        return Build.VERSION.SDK_INT >= 24 ? wrap(C4318ew.m20163a()) : create(Locale.getDefault());
    }

    @NonNull
    @Size(min = 1)
    public static LocaleListCompat getDefault() {
        return Build.VERSION.SDK_INT >= 24 ? wrap(C4189cw.m19776a()) : create(Locale.getDefault());
    }
    ...
    public static LocaleListCompat wrap(Object obj) {
        return wrap(C4254dw.m19995a(obj));
    }
}
