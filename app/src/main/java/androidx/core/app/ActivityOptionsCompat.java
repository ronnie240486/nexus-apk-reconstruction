...
public class ActivityOptionsCompat {
    ...
    public static class ActivityOptionsCompatImpl extends ActivityOptionsCompat {
        ...
        public Rect getLaunchBounds() {
            ...
            return C1097R1.m4920a(this.mActivityOptions);
        }

        @Override // androidx.core.app.ActivityOptionsCompat
        public void requestUsageTimeReport(@NonNull PendingIntent pendingIntent) {
            if (Build.VERSION.SDK_INT >= 23) {
                C1223T1.m5738a(this.mActivityOptions, pendingIntent);
            }
        }
        ...
        public ActivityOptionsCompat setLaunchBounds(@Nullable Rect rect) {
            return Build.VERSION.SDK_INT < 24 ? this : new ActivityOptionsCompatImpl(C1160S1.m5420a(this.mActivityOptions, rect));
        }
    ...
    public static ActivityOptionsCompat makeBasic() {
        return Build.VERSION.SDK_INT >= 23 ? new ActivityOptionsCompatImpl(C0903O1.m4074a()) : new ActivityOptionsCompat();
    }

    @NonNull
    public static ActivityOptionsCompat makeClipRevealAnimation(@NonNull View view, int i, int i2, int i3, int i4) {
        return Build.VERSION.SDK_INT >= 23 ? new ActivityOptionsCompatImpl(C0777M1.m3639a(view, i, i2, i3, i4)) : new ActivityOptionsCompat();
    }
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(@NonNull Activity activity, @NonNull View view, @NonNull String str) {
        return Build.VERSION.SDK_INT >= 21 ? new ActivityOptionsCompatImpl(C0840N1.m3913a(activity, view, str)) : new ActivityOptionsCompat();
    }

    @NonNull
    public static ActivityOptionsCompat makeTaskLaunchBehind() {
        return Build.VERSION.SDK_INT >= 21 ? new ActivityOptionsCompatImpl(C1033Q1.m4576a()) : new ActivityOptionsCompat();
    }
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(@NonNull Activity activity, Pair<View, String>... pairArr) {
        ...
        return new ActivityOptionsCompatImpl(C0970P1.m4365a(activity, pairArr2));
    }
}
