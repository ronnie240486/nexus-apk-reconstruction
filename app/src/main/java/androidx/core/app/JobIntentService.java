...
public abstract class JobIntentService extends Service {
    ...
    public static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        public final class WrapperWorkItem implements GenericWorkItem {
                ...
                synchronized (JobServiceEngineImpl.this.mLock) {
                    try {
                        ...
                        if (jobParameters != null) {
                            C4766lt.m22014a(jobParameters, this.mJobWork);
                        }
                    } catch (Throwable th) {
                        throw th;
                    }
            ...
            @Override // androidx.core.app.JobIntentService.GenericWorkItem
            public Intent getIntent() {
                return C4703kt.m21853a(this.mJobWork);
            }
        }
        ...
        public GenericWorkItem dequeueWork() {
            synchronized (this.mLock) {
                try {
                    ...
                    JobWorkItem jobWorkItemM21658a = C4639jt.m21658a(jobParameters);
                    if (jobWorkItemM21658a == null) {
                        return null;
                    }
                    C4703kt.m21853a(jobWorkItemM21658a).setExtrasClassLoader(this.mService.getClassLoader());
                    return new WrapperWorkItem(jobWorkItemM21658a);
                } catch (Throwable th) {
                    throw th;
                }
            }
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbM27771a = C5274qy.m27771a("Given job ID ", i, " is different than previous ");
                sbM27771a.append(this.mJobId);
                throw new IllegalArgumentException(sbM27771a.toString());
            }
        }
