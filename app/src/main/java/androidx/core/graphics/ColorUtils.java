...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, m14515to = 127.0d) double d2, @FloatRange(from = -128.0d, m14515to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, m14515to = 127.0d) double d2, @FloatRange(from = -128.0d, m14515to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i2, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i3, @NonNull float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i2, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i2, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Z) double d3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = 0.0d, m14515to = XYZ_WHITE_REFERENCE_Z) double d3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, m14515to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i2) * f) + (Color.alpha(i) * f2)), (int) ((Color.red(i2) * f) + (Color.red(i) * f2)), (int) ((Color.green(i2) * f) + (Color.green(i) * f2)), (int) ((Color.blue(i2) * f) + (Color.blue(i) * f2)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, m14515to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, m14515to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, m14516to = IjkMediaMeta.AV_CH_LAYOUT_7POINT1_WIDE_BACK) int i2) {
        if (i2 < 0 || i2 > 255) {
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        if (!Objects.equals(C5866za.m30011a(color), C5866za.m30011a(color2))) {
            throw new IllegalArgumentException("Color models must match (" + C5866za.m30011a(color) + " vs. " + C5866za.m30011a(color2) + C1313UP.f3459l);
        }
        if (!Objects.equals(C0175Ca.m1019a(color2), C0175Ca.m1019a(color))) {
            color = C0303Ea.m1655a(color, C0175Ca.m1019a(color2));
        }
        float[] fArrM1857a = C0366Fa.m1857a(color);
        float[] fArrM1857a2 = C0366Fa.m1857a(color2);
        float fM204a = C0039Aa.m204a(color);
        float fM204a2 = (1.0f - fM204a) * C0039Aa.m204a(color2);
        int iM527a = C0103Ba.m527a(color2) - 1;
        float f = fM204a + fM204a2;
        fArrM1857a2[iM527a] = f;
        if (f > 0.0f) {
            fM204a /= f;
            fM204a2 /= f;
        }
        for (int i = 0; i < iM527a; i++) {
            fArrM1857a2[i] = (fArrM1857a2[i] * fM204a2) + (fArrM1857a[i] * fM204a);
        }
        return C0239Da.m1401a(fArrM1857a2, C0175Ca.m1019a(color2));
    }
