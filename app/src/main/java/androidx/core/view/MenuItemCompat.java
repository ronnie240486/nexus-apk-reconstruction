...
public final class MenuItemCompat {
    ...
    public static int getAlphabeticModifiers(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5360sC.m28127a(menuItem);
        }
        return 0;
    }
    ...
    public static CharSequence getContentDescription(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5772yC.m29772a(menuItem);
        }
        return null;
    }
    ...
    public static ColorStateList getIconTintList(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5707xC.m29453a(menuItem);
        }
        return null;
    }
    ...
    public static PorterDuff.Mode getIconTintMode(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5226qC.m27627a(menuItem);
        }
        return null;
    }
    ...
    public static int getNumericModifiers(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5576vC.m28792a(menuItem);
        }
        return 0;
    }
    ...
    public static CharSequence getTooltipText(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C5842zC.m29958a(menuItem);
        }
        return null;
    }
    ...
    public static void setContentDescription(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C5505uC.m28590a(menuItem, charSequence);
        }
    }
    ...
    public static void setIconTintList(MenuItem menuItem, ColorStateList colorStateList) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C5163pC.m27413a(menuItem, colorStateList);
        }
    }
    ...
    public static void setShortcut(MenuItem menuItem, char c, char c2, int i, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C5289rC.m27801a(menuItem, c, c2, i, i2);
        }
    }
    ...
    public static void setTooltipText(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C0079BC.m471a(menuItem, charSequence);
        }
    }
