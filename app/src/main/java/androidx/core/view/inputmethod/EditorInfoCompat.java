...
public final class EditorInfoCompat {
    ...
    public static String[] getContentMimeTypes(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            String[] strArrM21122a = C4493hh.m21122a(editorInfo);
            return strArrM21122a != null ? strArrM21122a : EMPTY_STRING_ARRAY;
        }
    ...
    public static CharSequence getInitialTextAfterCursor(@NonNull EditorInfo editorInfo, int i, int i2) {
        ...
        return i4 != 0 ? charSequence.subSequence(i3, iMin) : TextUtils.substring(charSequence, i3, iMin);
    }
    ...
    public static void setContentMimeTypes(@NonNull EditorInfo editorInfo, @Nullable String[] strArr) {
        if (Build.VERSION.SDK_INT >= 25) {
            C4430gh.m20857a(editorInfo, strArr);
            return;
        }
