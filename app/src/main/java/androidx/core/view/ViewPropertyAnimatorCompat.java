...
import p000.C5934c30;
import p000.C5943d30;
import p000.C5950e30;
import p000.C5957f30;
...
public final class ViewPropertyAnimatorCompat {
    ...
    public ViewPropertyAnimatorCompat translationZ(float f) {
        ...
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            C5957f30.m20228a(view.animate(), f);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat translationZBy(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            C5950e30.m20038a(view.animate(), f);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat m14524x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    public ViewPropertyAnimatorCompat m14525y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    public ViewPropertyAnimatorCompat m14526z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            C5943d30.m19801a(view.animate(), f);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat zBy(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            C5934c30.m14760a(view.animate(), f);
        }
        return this;
    }
}
