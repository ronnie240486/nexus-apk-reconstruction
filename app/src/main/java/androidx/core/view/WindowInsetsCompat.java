...
import p000.C5630w2;
import p000.C5915a50;
import p000.C5929b50;
import p000.C5938c50;
import p000.C5945d50;
import p000.C5952e50;
import p000.C5959f50;
import p000.C5968g50;
import p000.C5975h50;
import p000.C5982i50;
import p000.C5989j50;
import p000.C5996k50;
import p000.C6003l50;
import p000.C6010m50;
import p000.C6017n50;
import p000.C6024o50;
import p000.C6031p50;
import p000.C6038q50;
import p000.C6045r50;
import p000.C6052s50;
import p000.C6059t50;
import p000.C6066u50;
import p000.C6073v50;
import p000.C6080w50;
import p000.F40;
import p000.G40;
import p000.I40;
import p000.J40;
...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat windowInsetsCompatBuild = new Builder().setStableInsets(Insets.m14522of(rect)).setSystemWindowInsets(Insets.m14522of(rect2)).build();
    ...
    public static class BuilderImpl {
        ...
        public final void applyInsetTypes() {
            ...
            if (insetsArr != null) {
                Insets insetsMax = insetsArr[Type.indexOf(1)];
                Insets insets4 = this.mInsetsTypeMask[Type.indexOf(2)];
                ...
                setSystemWindowInsets(insetsMax);
                insets = this.mInsetsTypeMask[Type.indexOf(16)];
                if (insets != null) {
                    setSystemGestureInsets(insets);
                }
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mInsets = G40.m1986a(windowInsets, insets.left, insets.top, insets.right, insets.bottom);
            }
        }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public WindowInsetsCompat build() {
            applyInsetTypes();
            WindowInsetsCompat windowInsetsCompat = WindowInsetsCompat.toWindowInsetsCompat(L40.m3411a(this.mPlatBuilder));
            windowInsetsCompat.setOverriddenInsets(this.mInsetsTypeMask);
            return windowInsetsCompat;
        }
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setDisplayCutout(@Nullable DisplayCutoutCompat displayCutoutCompat) {
            O40.m4081a(this.mPlatBuilder, displayCutoutCompat != null ? displayCutoutCompat.unwrap() : null);
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setMandatorySystemGestureInsets(@NonNull Insets insets) {
            M40.m3648a(this.mPlatBuilder, insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setStableInsets(@NonNull Insets insets) {
            J40.m2899a(this.mPlatBuilder, insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setSystemGestureInsets(@NonNull Insets insets) {
            K40.m3078a(this.mPlatBuilder, insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setSystemWindowInsets(@NonNull Insets insets) {
            I40.m2461a(this.mPlatBuilder, insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setTappableElementInsets(@NonNull Insets insets) {
            N40.m3920a(this.mPlatBuilder, insets.toPlatformInsets());
        }
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsets(int i, @NonNull Insets insets) {
            P40.m4371a(this.mPlatBuilder, TypeImpl30.toPlatformType(i), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsetsIgnoringVisibility(int i, @NonNull Insets insets) {
            R40.m4926a(this.mPlatBuilder, TypeImpl30.toPlatformType(i), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setVisible(int i, boolean z) {
            Q40.m4582a(this.mPlatBuilder, TypeImpl30.toPlatformType(i), z);
        }
    ...
    public static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i, boolean z) {
            ...
            int i2;
            if (i == 1) {
                return z ? Insets.m14521of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0) : Insets.m14521of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m14521of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m14521of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i != 8) {
                if (i == 16) {
                ...
                return displayCutout != null ? Insets.m14521of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom()) : Insets.NONE;
            }
            ...
            if (i3 > rootStableInsets2.bottom) {
                return Insets.m14521of(0, 0, 0, i3);
            }
            Insets insets = this.mRootViewVisibleInsets;
            return (insets == null || insets.equals(Insets.NONE) || (i2 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.m14521of(0, 0, 0, i2);
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m14521of(S40.m5437a(this.mPlatformInsets), T40.m5749a(this.mPlatformInsets), U40.m6162a(this.mPlatformInsets), V40.m6443a(this.mPlatformInsets));
            }
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        public boolean isRound() {
            return W40.m6703a(this.mPlatformInsets);
        }
    ...
    public static class Impl21 extends Impl20 {
        ...
        @NonNull
        public WindowInsetsCompat consumeStableInsets() {
            return WindowInsetsCompat.toWindowInsetsCompat(X40.m6991a(this.mPlatformInsets));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public WindowInsetsCompat consumeSystemWindowInsets() {
            return WindowInsetsCompat.toWindowInsetsCompat(C5945d50.m19874a(this.mPlatformInsets));
        }
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m14521of(Y40.m8052a(this.mPlatformInsets), Z40.m8606a(this.mPlatformInsets), C5915a50.m8880a(this.mPlatformInsets), C5929b50.m14593a(this.mPlatformInsets));
            }
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        public boolean isConsumed() {
            return C5938c50.m16434a(this.mPlatformInsets);
        }
    ...
    public static class Impl28 extends Impl21 {
        ...
        @NonNull
        public WindowInsetsCompat consumeDisplayCutout() {
            return WindowInsetsCompat.toWindowInsetsCompat(C5959f50.m20231a(this.mPlatformInsets));
        }
        ...
        @Nullable
        public DisplayCutoutCompat getDisplayCutout() {
            return DisplayCutoutCompat.wrap(C5952e50.m20042a(this.mPlatformInsets));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl
        public int hashCode() {
            return C5968g50.m20726a(this.mPlatformInsets);
        }
    ...
    public static class Impl29 extends Impl28 {
        ...
        public Insets getMandatorySystemGestureInsets() {
            if (this.mMandatorySystemGestureInsets == null) {
                this.mMandatorySystemGestureInsets = Insets.toCompatInsets(C5989j50.m21498a(this.mPlatformInsets));
            }
        ...
        public Insets getSystemGestureInsets() {
            if (this.mSystemGestureInsets == null) {
                this.mSystemGestureInsets = Insets.toCompatInsets(C5996k50.m21701a(this.mPlatformInsets));
            }
        ...
        public Insets getTappableElementInsets() {
            if (this.mTappableElementInsets == null) {
                this.mTappableElementInsets = Insets.toCompatInsets(C5975h50.m20947a(this.mPlatformInsets));
            }
        ...
        @NonNull
        public WindowInsetsCompat inset(int i, int i2, int i3, int i4) {
            return WindowInsetsCompat.toWindowInsetsCompat(C5982i50.m21296a(this.mPlatformInsets, i, i2, i3, i4));
        }
    ...
    public static class Impl30 extends Impl29 {
        ...
        @NonNull
        static final WindowInsetsCompat CONSUMED = WindowInsetsCompat.toWindowInsetsCompat(C6017n50.m22305a());
        ...
        @NonNull
        public Insets getInsets(int i) {
            return Insets.toCompatInsets(C6010m50.m22053a(this.mPlatformInsets, TypeImpl30.toPlatformType(i)));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public Insets getInsetsIgnoringVisibility(int i) {
            return Insets.toCompatInsets(C6003l50.m21902a(this.mPlatformInsets, TypeImpl30.toPlatformType(i)));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        public boolean isVisible(int i) {
            return C6024o50.m22588a(this.mPlatformInsets, TypeImpl30.toPlatformType(i));
        }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(C5630w2.m29215a("type needs to be >= FIRST and <= LAST, type=", i));
        }
    ...
    public static final class TypeImpl30 {
        ...
        public static int toPlatformType(int i) {
            ...
            for (int i3 = 1; i3 <= 256; i3 <<= 1) {
                if ((i & i3) != 0) {
                    if (i3 == 1) {
                        iM27368a = C6031p50.m27368a();
                    } else if (i3 == 2) {
                        iM27368a = C6038q50.m27592a();
                    } else if (i3 == 4) {
                        iM27368a = C6045r50.m27793a();
                    } else if (i3 == 8) {
                        iM27368a = C6052s50.m28117a();
                    } else if (i3 == 16) {
                        iM27368a = C6059t50.m28365a();
                    } else if (i3 == 32) {
                        iM27368a = C6066u50.m28570a();
                    } else if (i3 == 64) {
                        iM27368a = C6073v50.m28758a();
                    } else if (i3 == 128) {
                        iM27368a = C6080w50.m29221a();
                    }
                    i2 |= iM27368a;
                }
            }
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m14521of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m14521of(i, i2, i3, i4)).build();
    }
    ...
    public static WindowInsetsCompat toWindowInsetsCompat(@NonNull WindowInsets windowInsets, @Nullable View view) {
        WindowInsetsCompat windowInsetsCompat = new WindowInsetsCompat(F40.m1773a(Preconditions.checkNotNull(windowInsets)));
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m14522of(rect)).build();
    }
}
