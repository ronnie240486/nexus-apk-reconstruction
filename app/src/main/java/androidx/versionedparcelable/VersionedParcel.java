...
import p000.C0060Av;
import p000.C1313UP;
import p000.C6047s00;
import p000.C6054t00;
import p000.C6061u00;
import p000.C6068v00;
...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(C0060Av.m278a("VersionedParcelable encountered IOException writing serializable object (name = ", name, C1313UP.f3459l), e);
        }
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(C0060Av.m278a("VersionedParcelable encountered IOException reading a Serializable object (name = ", string, C1313UP.f3459l), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(C0060Av.m278a("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", string, C1313UP.f3459l), e2);
        }
    }
    ...
    public void writeSize(Size size, int i) {
        ...
        if (size != null) {
            writeInt(C6061u00.m28560a(size));
            writeInt(C6068v00.m28743a(size));
        }
    }
    ...
    public void writeSizeF(SizeF sizeF, int i) {
        ...
        if (sizeF != null) {
            writeFloat(C6047s00.m28096a(sizeF));
            writeFloat(C6054t00.m28358a(sizeF));
        }
    }
