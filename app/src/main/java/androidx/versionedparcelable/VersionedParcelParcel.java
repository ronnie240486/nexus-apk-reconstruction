...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i, C0786MA.m3668a(new StringBuilder(), this.mPrefix, OutputFormat.f16582n), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
